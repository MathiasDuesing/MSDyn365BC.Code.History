codeunit 442 "Sales-Post Prepayments"
{
            ...
            case DocumentType of
                DocumentType::Invoice:
                    begin
                        ...
                        SalesSetup.TestField("Jnl. Templ. Prep. S. Inv.");
                        GenJournalTemplate.Get(SalesSetup."Jnl. Templ. Prep. S. Inv.");
                ...
                DocumentType::"Credit Memo":
                    begin
                        ...
                        SalesSetup.TestField("Jnl. Templ. Prep. S. Cr. Memo");
                        GenJournalTemplate.Get(SalesSetup."Jnl. Templ. Prep. S. Cr. Memo");
    ...
    begin
        with PrepmtInvLineBuf do begin
            ...
            "Original Pmt. Disc. Possible" := SalesLine."Prepmt. Pmt. Disc. Amount";
        end;
    ...
    begin
        with PrepmtInvLineBuffer do begin
            ...
            SalesInvLine."Pmt. Discount Amount" := "Original Pmt. Disc. Possible";
    ...
    begin
        with PrepmtInvLineBuffer do begin
            ...
            SalesCrMemoLine."Pmt. Discount Amount" := "Original Pmt. Disc. Possible";
