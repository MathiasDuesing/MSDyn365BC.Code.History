table 5615 "FA Allocation"
{
    ...
    fields
    {
        ...
        field(8; "Allocation Type"; Option)
        {
            ...
            OptionCaption = 'Acquisition,Depreciation,Write-Down,Appreciation,Custom 1,Custom 2,Disposal,Maintenance,Gain,Loss,Book Value (Gain),Book Value (Loss),Derogatory';
            OptionMembers = Acquisition,Depreciation,"Write-Down",Appreciation,"Custom 1","Custom 2",Disposal,Maintenance,Gain,Loss,"Book Value (Gain)","Book Value (Loss)",Derogatory;
        }
