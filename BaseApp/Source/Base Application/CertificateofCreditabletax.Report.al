...
{
    DefaultLayout = RDLC;
    RDLCLayout = './CertificateofCreditabletax.rdlc';
    ...
    dataset
    {
        dataitem("WHT Entry"; "WHT Entry")
        {
            ...
            column(WHT_Entry__WHT_Entry___WHT_Revenue_Type_; "WHT Revenue Type")
            {
            }
            column(WHT_Entry__WHT_Entry___WHT_Prod__Posting_Group_; "WHT Prod. Posting Group")
            {
            }
            column(WHT_Entry__WHT_Entry___WHT_Bus__Posting_Group_; "WHT Bus. Posting Group")
            {
            }
            ...
            column(Text1500011_Text1500012; Text1500011 + Text1500012)
            {
            }
            ...
            column(WHT_Entry__WHT_Entry___WHT_Revenue_Type_Caption; FieldCaption("WHT Revenue Type"))
            {
            }
            column(WHT_Entry__WHT_Entry___WHT_Prod__Posting_Group_Caption; FieldCaption("WHT Prod. Posting Group"))
            {
            }
            column(WHT_Entry__WHT_Entry___WHT_Bus__Posting_Group_Caption; FieldCaption("WHT Bus. Posting Group"))
            {
            }
    ...
    var
        ...
        Vend: Record Vendor;
        Text001: Label 'Please enter the Pay to Vendor ID in the filter';
        Text1500011: Label 'We declare, under the penalties of perjury, that this certificate has been made in good faith, verified by me, and to the best of my knowledge and belief,';
        Text1500012: Label 'is true and correct, pursuant to the provisions of the National Internal Revenue Code, as amended, and the regulations issued under authority thereof.';
        StartDate: Date;
        EndDate: Date;
