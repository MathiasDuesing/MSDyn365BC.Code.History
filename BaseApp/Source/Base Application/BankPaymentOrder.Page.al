        ...
        area(content)
        {
            group("Payment Order")
            {
                ...
                group(Beneficiary)
                {
                    ...
                    field("Payer Vendor No."; "Payer Vendor No.")
                    {
                        ApplicationArea = Basic, Suite;
            ...
            group("Tax Information")
            {
                ...
                field("Taxpayer Status"; "Taxpayer Status")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the taxpayer status associated with the general journal line.';
                }
                field("Payment Reason Code"; "Payment Reason Code")
                {
                    ApplicationArea = Basic, Suite;
