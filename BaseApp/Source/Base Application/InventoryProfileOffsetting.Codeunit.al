codeunit 99000854 "Inventory Profile Offsetting"
{
    ...
    begin
        ...
        with SisterInvProfile do begin
            ...
            SetRange("CD No.", CurrInvProfile."CD No.");
    ...
    begin
        ...
        if SpecificCDTracking then
            ToInvProfile."CD No." := FromInvProfile."CD No.";
    ...
    begin
        with InvProfile do begin
            ...
            HandleLot := (("Lot No." <> '') or ("CD No." <> '')) and (SpecificLotTracking or SpecificCDTracking);
