codeunit 5815 "Undo Sales Shipment Line"
{
    ...
    begin
        with OldSalesShptLine do begin
            ...
            NewSalesShptLine.Amount := -Amount;
            NewSalesShptLine."Amount Including VAT" := -"Amount Including VAT";
            NewSalesShptLine."Amount (LCY)" := -"Amount (LCY)";
            NewSalesShptLine."Amount Including VAT (LCY)" := -"Amount Including VAT (LCY)";
