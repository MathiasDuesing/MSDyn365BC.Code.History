    ...
    layout
    {
        area(content)
        {
            ...
            group(Numbering)
            {
                ...
                field("Posted Writeoff Nos."; Rec."Posted Writeoff Nos.")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the number series from which numbers are assigned to new records.';
                }
                field("Posted Release Nos."; Rec."Posted Release Nos.")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the number series from which numbers are assigned to new records.';
                }
                field("Posted Disposal Nos."; Rec."Posted Disposal Nos.")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the number series from which numbers are assigned to new records.';
                }
            ...
            group("Assessed Tax")
            {
                ...
                field("AT Declaration Template Code"; Rec."AT Declaration Template Code")
                {
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("AT Advance Template Code"; Rec."AT Advance Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
            ...
            {
                Caption = 'Templates';
                field("INV-1 Template Code"; Rec."INV-1 Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("INV-1a Template Code"; Rec."INV-1a Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("INV-11 Template Code"; Rec."INV-11 Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("INV-18 Template Code"; Rec."INV-18 Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("FA-1 Template Code"; Rec."FA-1 Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("M-2a Template Code"; Rec."M-2a Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("FA-2 Template Code"; Rec."FA-2 Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("FA-14 Template Code"; Rec."FA-14 Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("FA-3 Template Code"; Rec."FA-3 Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("FA-4 Template Code"; Rec."FA-4 Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("FA-4a Template Code"; Rec."FA-4a Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("FA-6 Template Code"; Rec."FA-6 Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("FA-15 Template Code"; Rec."FA-15 Template Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
