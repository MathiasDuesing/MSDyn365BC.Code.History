table 352 "Default Dimension"
{
    ...
    fields
    {
        ...
        field(11791; "Dimension Description Field ID"; Integer)
        {
            ...
            begin
                lreField.SetRange(TableNo, "Table ID");
                if lreField.Get("Table ID", "Dimension Description Field ID") then;

                if FieldSelection.Open(lreField) then
                    Validate("Dimension Description Field ID", lreField."No.");
            end;

            trigger OnValidate()
            begin
                if "Dimension Description Field ID" = 0 then
                    "Dimension Description Update" := "Dimension Description Update"::" "
                else begin
                    TestField("No.", '');
        ...
        field(11793; "Dimension Description Update"; Option)
        {
            ...
            begin
                if "Dimension Description Update" <> "Dimension Description Update"::" " then begin
                    TestField("Dimension Description Field ID");
                    TestField("Automatic Create", true);
                end;
            end;
        }
    ...
    begin
        ...
        case TableID of
            ...
            DATABASE::"Vendor Template":
                UpdateVendorTempGlobalDimCode(GlobalDimCodeNo, AccNo, NewDimValue);
