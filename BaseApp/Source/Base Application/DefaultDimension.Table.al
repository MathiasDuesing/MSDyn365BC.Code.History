table 352 "Default Dimension"
{
    ...
    local procedure UpdateFAChargeGlobalDimCode(GlobalDimCodeNo: Integer; FAChargeNo: Code[20]; NewDimValue: Code[20])
    var
    ...
    local procedure UpdateCustAgrmtGlobalDimCode(GlobalDimCodeNo: Integer; AgrmtNo: Code[20]; NewDimValue: Code[20])
    var
    ...
    local procedure UpdateVendAgrmtGlobalDimCode(GlobalDimCodeNo: Integer; AgrmtNo: Code[20]; NewDimValue: Code[20])
    var
