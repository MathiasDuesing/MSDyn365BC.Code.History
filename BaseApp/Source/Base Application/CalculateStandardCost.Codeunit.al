codeunit 5812 "Calculate Standard Cost"
{
    ...
    local procedure CalcRtngCostPerUnit(Type: Enum "Capacity Type Routing"; No: Code[20]; var DirUnitCost: Decimal; var IndirCostPct: Decimal; var OvhdRate: Decimal; var UnitCost: Decimal; var UnitCostCalculation: Option Time,Unit; Item: Record Item; StandardTaskCode: Code[20])
    var
    ...
    procedure CalcRtngLineCost(RoutingLine: Record "Routing Line"; MfgItemQtyBase: Decimal; var SLCap: Decimal; var SLSub: Decimal; var SLCapOvhd: Decimal; var Item: Record Item)
    var
        WorkCenter: Record "Work Center";
