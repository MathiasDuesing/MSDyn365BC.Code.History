table 25 "Vendor Ledger Entry"
{
    ...
    keys
    {
        ...
        key(Key2; "Vendor No.", "Posting Date", "Currency Code", "Agreement No.")
        {
        ...
        key(Key11; "Vendor No.", "Global Dimension 1 Code", "Global Dimension 2 Code", "Posting Date", "Currency Code", "Agreement No.")
        {
            Enabled = false;
            SumIndexFields = "Purchase (LCY)", "Inv. Discount (LCY)";
        }
        ...
        key(Key16; "Prepmt. Diff. Vend. Entry No.", "Prepmt. Diff. Appln. Entry No.")
        {
        }
        key(Key17; "Payroll Ledger Entry No.")
        {
        }
        key(Key18; "Vendor VAT Invoice Rcvd Date", "Entry No.")
        {
        }
        key(Key19; "Vendor Posting Group")
        {
        }
        key(Key20; "Pmt. Discount Date")
        {
        }
