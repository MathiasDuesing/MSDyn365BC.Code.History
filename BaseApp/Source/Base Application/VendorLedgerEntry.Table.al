table 25 "Vendor Ledger Entry"
{
    ...
    fields
    {
        ...
        field(11632; "EFT Register No."; Integer)
        {
            BlankZero = true;
    ...
    keys
    {
        ...
        key(Key16; "Vendor No.", "Document Date", "BAS Adjustment")
        {
        }
        key(Key17; "Vendor No.", Positive, "Applies-to Doc. Type", "Applies-to Doc. No.", "Due Date")
        {
        }
        key(Key18; "Document No.", "Document Type", "Vendor No.")
        {
        }
        key(Key19; "EFT Register No.")
        {
        }
