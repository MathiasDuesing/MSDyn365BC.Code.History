    ...
    begin
        ...
        with ReqLine2 do begin
            ...
            if "Prod. Order No." <> '' then begin
                PurchOrderLine."Base UM Qty/Pricelist UM Qty" := "Base UM Qty/Pricelist UM Qty";
                PurchOrderLine."UoM for Pricelist" := "UoM for Pricelist";
                PurchOrderLine."Pricelist UM Qty/Base UM Qty" := "Pricelist UM Qty/Base UM Qty";
                PurchOrderLine."Pricelist Cost" := "Pricelist Cost";
                PurchOrderLine."WIP Item" := "WIP Item";
            end;
