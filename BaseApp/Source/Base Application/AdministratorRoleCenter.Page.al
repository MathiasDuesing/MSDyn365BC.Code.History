    ...
    actions
    {
        ...
        area(embedding)
        {
            ...
            action("Statutory Report Groups")
            {
                ...
                ToolTip = 'View or edit the groups that you have set up for electronic tax reporting. ';
            }
            action("Format Versions")
            {
                Caption = 'Format Versions';
                RunObject = Page "Format Versions";
                ToolTip = 'View or edit the setup of the different report formats. This information includes when to use a report, the XML schema to use, and the required data format.';
            }
            action("Bank Dirrectory List")
            {
                Caption = 'Bank Dirrectory List';
                RunObject = Page "Bank Directory List";
            }
            action("OKATO Codes")
            {
