...
page 393 "Item Reclass. Journal"
{
    ...
    actions
    {
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("&Get Standard Journals")
                {
                    ...
                    ToolTip = 'This function gets standard journals.';
                    ...
                    begin
                        ...
                        if PAGE.RunModal(PAGE::"Standard Item Journals", StdItemJnl) = ACTION::LookupOK then begin
                            StdItemJnl.CreateTransfJnlFromStdJnl(StdItemJnl, CurrentJnlBatchName);
                            Message(LinesInsertedMsg, StdItemJnl.Code);
                        end;
                        // NAVCZ
                    end;
                }
                action("&Save as Standard Journal")
                {
                    ...
                    ToolTip = 'This function saves this journals as standard journals.';
                    ObsoleteState = Pending;
                    ObsoleteReason = 'The functionality will be removed and this action should not be used.';
                    ObsoleteTag = '20.0';
                    ...
                    begin
                        // NAVCZ
                        ItemJnlLine.SetFilter("Journal Template Name", "Journal Template Name");
                        ItemJnlLine.SetFilter("Journal Batch Name", CurrentJnlBatchName);
                        ...
                        SaveAsStdItemJnl.Initialise(ItemJnlLine, ItemJnlBatch);
                        SaveAsStdItemJnl.RunModal();
                        if not SaveAsStdItemJnl.GetStdItemJournal(StdItemJnl) then
                            exit;
                        Message(JnlCreatedMsg, StdItemJnl.Code);
                        // NAVCZ
                    end;
                }
            }
        ...
        area(Promoted)
        {
            group(Category_Process)
            {
                ...
                actionref(Action60_Promoted; Action60)
                {
                    ObsoleteState = Pending;
                    ObsoleteReason = 'The functionality will be removed and this action should not be used.';
                    ObsoleteTag = '20.0';
    ...
    var
        ...
        LinesInsertedMsg: Label 'Item Journal lines have been successfully inserted from Standard Item Journal %1.';
        JnlCreatedMsg: Label 'Standard Item Journal %1 has been successfully created.';
