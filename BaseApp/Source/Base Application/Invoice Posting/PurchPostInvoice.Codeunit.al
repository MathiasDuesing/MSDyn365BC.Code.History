codeunit 816 "Purch. Post Invoice" implements "Invoice Posting"
{
    ...
    begin
        ...
        InvoicePostingBuffer.UpdateVATBase(TotalVATBase, TotalVATBaseACY);
        InvoicePostingBuffer.SetNDAmounts(NonDeductibleVAT, NonDeductibleVATACY);
    ...
    local procedure InitTotalAmounts(PurchLine: Record "Purchase Line"; PurchLineACY: Record "Purchase Line"; var TotalVAT: Decimal; var TotalVATACY: Decimal; var TotalAmount: Decimal; var TotalAmountACY: Decimal; var TotalVATBase: Decimal; var TotalVATBaseACY: Decimal; var NonDeDuctibleVAT: Decimal; var NonDeDuctibleVATACY: Decimal)
    begin
    ...
    begin
        ...
        GenJnlLine."Non Ded. VAT Amount" := InvoicePostingBuffer."Non Deductible VAT Amt.";
        GenJnlLine."Non Ded. Source Curr. VAT Amt." := InvoicePostingBuffer."Non Ded. VAT Amt. (ACY)";
...
#if not CLEAN20
        GenJnlLine."Original Pmt. Disc. Possible" := GenJnlLine."Orig. Pmt. Disc. Possible";
        GenJnlLine."Org. Pmt. Disc. Possible (LCY)" := GenJnlLine."Orig. Pmt. Disc. Possible(LCY)";
#endif
