codeunit 815 "Sales Post Invoice" implements "Invoice Posting"
{
    ...
    begin
        ...
        CustLedgEntry2.CalcSums("Remaining Pmt. Disc. Possible");
        TotalRemainPmtDiscPossible := CustLedgEntry2."Remaining Pmt. Disc. Possible";
        ...
        SetAmountsForBalancingEntry(SalesHeader, CustLedgEntry2, GenJnlLine, TotalRemainPmtDiscPossible);
    ...
    local procedure SetAmountsForBalancingEntry(SalesHeader: Record "Sales Header"; var CustLedgEntry: Record "Cust. Ledger Entry"; var GenJnlLine: Record "Gen. Journal Line"; TotalRemainPmtDiscPossible: Decimal)
    var
        PaymentMethod: Record "Payment Method";
        IsHandled: Boolean;
    begin
        ...
        if PaymentMethod."Free Type" = PaymentMethod."Free Type"::"Only VAT Amt." then begin
            GenJnlLine.Amount := TotalSalesLine."Amount Including VAT" - TotalSalesLine.Amount;
            GenJnlLine."Amount (LCY)" := TotalSalesLineLCY."Amount Including VAT" - TotalSalesLineLCY.Amount;
        end else begin
            GenJnlLine.Amount := TotalSalesLine."Amount Including VAT" + TotalRemainPmtDiscPossible;
