codeunit 815 "Sales Post Invoice" implements "Invoice Posting"
{
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            // TODO "WHT Product Posting Group" := TempSalesLineGlobal."WHT Product Posting Group";
            ...
            Amount := -TotalSalesLine."Amount Including VAT" + SalesHeader."WHT Amount";
            "Source Currency Amount" := -TotalSalesLine."Amount Including VAT" + SalesHeader."WHT Amount";
            if (SalesHeader."WHT Amount" <> 0) and (SalesHeader."Currency Code" <> '') then
                ...
                "Amount (LCY)" := -(TotalSalesLineLCY."Amount Including VAT" - SalesHeader."WHT Amount");
