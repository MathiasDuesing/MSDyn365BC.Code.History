codeunit 815 "Sales Post Invoice" implements "Invoice Posting"
{
    ...
    begin
        ...
        if SalesSetup."Post Payment Discount" then begin
            if SalesLine."VAT Calculation Type" = SalesLine."VAT Calculation Type"::"Reverse Charge VAT" then
                InvoicePostingBuffer.CalcDiscountNoVAT(-SalesLine."Pmt. Discount Amount", -SalesLineACY."Pmt. Discount Amount")
            else
    ...
    begin
        ...
        GenJnlLine."Sales Invoice Type" := SalesHeader."Invoice Type";
        GenJnlLine."Sales Cr. Memo Type" := SalesHeader."Cr. Memo Type";
        GenJnlLine."Sales Special Scheme Code" := SalesHeader."Special Scheme Code";
        GenJnlLine."Correction Type" := SalesHeader."Correction Type";
        GenJnlLine."Corrected Invoice No." := SalesHeader."Corrected Invoice No.";
        GenJnlLine."Succeeded Company Name" := SalesHeader."Succeeded Company Name";
        GenJnlLine."Succeeded VAT Registration No." := SalesHeader."Succeeded VAT Registration No.";
    ...
    begin
        ...
        GenJnlLine."Pmt. Discount Given/Rec. (LCY)" := -TotalSalesLineLCY."Pmt. Discount Amount";
        GenJnlLine."Orig. Pmt. Disc. Possible" := -TotalSalesLine."Pmt. Discount Amount";
        GenJnlLine."Orig. Pmt. Disc. Possible(LCY)" :=
            CurrExchRate.ExchangeAmtFCYToLCY(
                SalesHeader.GetUseDate(), SalesHeader."Currency Code", -TotalSalesLine."Pmt. Discount Amount", SalesHeader."Currency Factor");
