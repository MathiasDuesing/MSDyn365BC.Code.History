codeunit 13 "Gen. Jnl.-Post Batch"
{
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            WHTGenJournalLine.SetRange("Journal Template Name", "Journal Template Name");
            WHTGenJournalLine.SetRange("Journal Batch Name", "Journal Batch Name");
            WHTGenJournalLine.SetRange("Is WHT", true);
            WHTGenJournalLine.SetRange("System-Created Entry", true);

            SetRange("Is WHT", false);
            FindSet(true, false);
            FirstLine := true;
            repeat
