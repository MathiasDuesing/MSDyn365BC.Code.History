page 134 "Posted Sales Credit Memo"
{
    ...
    InsertAllowed = false;
    PageType = Document;
    PromotedActionCategories = 'New,Process,Report,Credit Memo,Cancel,Navigate,Print/Send,Credit Card';
            ...
            group("Shipping and Billing")
            {
                ...
                group("Ship-to")
                {
                    ...
                    field("KPP Code"; "KPP Code")
                    {
                        ApplicationArea = Basic, Suite;
                        Editable = false;
                        ToolTip = 'Specifies the code of the company registration associated with this header.';
                    }
        ...
        area(navigation)
        {
            group("&Cr. Memo")
            {
                ...
                action("Return Receipts")
                {
                    ...
                    Image = ReturnReceipt;
                    ToolTip = 'Open the related posted return receipts.';
