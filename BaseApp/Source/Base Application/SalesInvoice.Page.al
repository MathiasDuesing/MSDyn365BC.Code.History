    ...
    layout
    {
        area(content)
        {
            ...
            group("Shipping and Billing")
            {
                ...
                field("External Document Text"; Rec."External Document Text")
                {
                    ApplicationArea = Basic, Suite;
        ...
        area(processing)
        {
            ...
            group("P&osting")
            {
                ...
                action(Printer)
                {
                    ...
                    trigger OnAction()
                    begin
                        PostDocument(CODEUNIT::"Sales-Post + Print", "Navigate After Posting"::"Posted Document");
                    end;
                }
                action("Email as PDF")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Post and &Email as PDF';
                    Ellipsis = true;
                    Image = Email;
                    //The property 'PromotedCategory' can only be set if the property 'Promoted' is set to 'true'
                    ...
                    trigger OnAction()
                    begin
                        PostDocument(CODEUNIT::"Sales-Post + Email", "Navigate After Posting"::"Posted Document");
                    end;
                }
                action("Post and Email")
                {
                    ...
                    Image = PostMail;
                    ToolTip = 'Finalize the sales document and attach it to an email addressed to the customer.';
                    Visible = false;
        ...
        area(Promoted)
        {
            group(Category_Process)
            {
                ...
                group(Category_Category5)
                {
                    ...
                    actionref(Printer_Promoted; Printer)
                    {
                    }
