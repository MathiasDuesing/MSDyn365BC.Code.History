page 43 "Sales Invoice"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group("Shipping and Billing")
            {
                ...
                {
                    ApplicationArea = Prepayments;
                    ToolTip = 'Specifies whether to combine prepayments on the sales order.';
                }
            }
            group("Foreign Trade")
            {
        ...
        area(processing)
        {
            ...
            group(Action1220032)
            {
                ...
                action("Link Advance Letter")
                {
                    ...
                    begin
                        // NAVCZ
                        AdvLetterLinkingCard.SetSalesDoc("Document Type", "No.");
    ...
    begin
        CurrPage.SalesLines.PAGE.UpdatePage(true); // NAVCZ
    end;
    ...
    var
        AdvLetter: Record "Sales Advance Letter Header";
        SalesAPTempl: Record "Sales Adv. Payment Template";
