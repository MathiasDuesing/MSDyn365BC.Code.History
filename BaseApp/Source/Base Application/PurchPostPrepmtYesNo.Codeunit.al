...
codeunit 445 "Purch.-Post Prepmt. (Yes/No)"
{
    ...
    begin
        ...
        with PurchHeader do begin
            ...
            if "Prepayment Type" = "Prepayment Type"::Advance then begin
                if GetSelectedInvoices(PurchHeader, PurchInvHeader) then
    ...
    begin
        ...
        with PurchHeader do begin
            ...
            PurchInvHeader.SetRange("Prepayment Order No.", "No.");
            if LetterNoToInvoice <> '' then
                PurchInvHeader.SetRange("Letter No.", LetterNoToInvoice);
    ...
    begin
        ...
        PurchPostAdvances.SetLetterNo(LetterNo);
    end;
