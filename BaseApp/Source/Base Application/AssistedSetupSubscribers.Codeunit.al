codeunit 1814 "Assisted Setup Subscribers"
{
    ...
    begin
        ...
        AssistedSetup.Add(GetAppId(), PAGE::"Sales Tax Setup Wizard", SalesTaxSetupTxt, AssistedSetupGroup::GettingStarted, VideoUrlSalesTaxSetupTxt, VideoCategory::GettingStarted, HelpSetupSalesTaxTxt, SalesTaxSetupDescriptionTxt);
        GLOBALLANGUAGE(Language.GetDefaultApplicationLanguageId());
        AssistedSetup.AddTranslation(PAGE::"Sales Tax Setup Wizard", Language.GetDefaultApplicationLanguageId(), SalesTaxSetupTxt);
        ...
        if NOT EnvironmentInfo.IsSaaS then begin
            ...
            GLOBALLANGUAGE(1033);
            AssistedSetup.AddTranslation(PAGE::"Azure AD App Setup Wizard", 1033, AzureAdSetupTxt);
            GLOBALLANGUAGE(CurrentGlobalLanguage);
        end;
        ...
        if not EnvironmentInfo.IsSaaS then begin
            AssistedSetup.Add(GetAppId(), PAGE::"Mexican CFDI Wizard", SetupMexicanCFDITxt, AssistedSetupGroup::Customize);
            GLOBALLANGUAGE(Language.GetDefaultApplicationLanguageId());
            AssistedSetup.AddTranslation(PAGE::"Mexican CFDI Wizard", Language.GetDefaultApplicationLanguageId(), SetupMexicanCFDITxt);
            GLOBALLANGUAGE(CurrentGlobalLanguage);
        end;
        UpdateStatus;
    end;
