table 121 "Purch. Rcpt. Line"
{
    ...
    begin
        ...
        repeat
            ...
            if not ExtTextLine then begin
                ...
                PurchLine."Prepmt. Amt. Incl. VAT" := 0;
                PurchLine."Prepayment Amount" := 0;
                PurchLine."Prepmt. VAT Base Amt." := 0;
                PurchLine."Prepmt Amt to Deduct" := 0;
                PurchLine."Prepmt Amt Deducted" := 0;
                PurchLine."Prepmt. Amount Inv. Incl. VAT" := 0;
                PurchLine."Prepmt. VAT Amount Inv." := 0;
    ...
    begin
        ...
        "Vendor Shipment No." := PurchRcptHeader."Vendor Shipment No."; // NAVCZ
