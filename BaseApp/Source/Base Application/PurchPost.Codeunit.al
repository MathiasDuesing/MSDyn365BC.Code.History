codeunit 90 "Purch.-Post"
{
    ...
    begin
        with PurchHeader do begin
            ...
            if GLSetup."Enable Russian Accounting" and not "Empl. Purchase" then
                DocSignMgt.CheckDocSignatures(DATABASE::"Purchase Header", "Document Type", "No.");
    ...
    local procedure PostVendorEntry(var PurchHeader: Record "Purchase Header"; TotalPurchLine2: Record "Purchase Line"; TotalPurchLineLCY2: Record "Purchase Line"; DocType: Option; DocNo: Code[20]; ExtDocNo: Code[35]; SourceCode: Code[10]; var CVLedgEntryBuf: Record "CV Ledger Entry Buffer")
    var
        GenJnlLine: Record "Gen. Journal Line";
    begin
                ...
                repeat
                    ...
                    if Item."Item Tracking Code" <> '' then begin
                        ...
                        ItemTrackingManagement.GetItemTrackingSetup(
                            ItemTrackingCode, CDTrackingSetup, ItemJnlLine."Entry Type"::Purchase, Inbound, ItemTrackingSetup);
