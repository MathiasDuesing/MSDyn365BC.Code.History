codeunit 90 "Purch.-Post"
{
    ...
    begin
        ...
        InitAmounts(PurchLine, TotalVAT, TotalVATACY, TotalAmount, TotalAmountACY, AmtToDefer, AmtToDeferACY,
          TotalVATBase, TotalVATBaseACY, NonDeductibleVAT, NonDeductibleVATACY, DeferralAccount);
        ...
        InvoicePostBuffer.UpdateVATBase(TotalVATBase, TotalVATBaseACY);
        InvoicePostBuffer.SetNDAmounts(NonDeductibleVAT, NonDeductibleVATACY);
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            "Original Pmt. Disc. Possible" := -TotalPurchLine2."Pmt. Discount Amount";
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            "Original Pmt. Disc. Possible" := TotalPurchLine."Pmt. Discount Amount";
            "Org. Pmt. Disc. Possible (LCY)" :=
              CurrExchRate.ExchangeAmtFCYToLCY(
    ...
    begin
        ...
        case InvoicePostBuffer."VAT Calculation Type" of
            InvoicePostBuffer."VAT Calculation Type"::"Reverse Charge VAT":
                if (InvoicePostBuffer."VAT Amount" = 0) and (InvoicePostBuffer."Non Deductible VAT Amt." = 0) then begin
                    VATPostingSetup.Get(
