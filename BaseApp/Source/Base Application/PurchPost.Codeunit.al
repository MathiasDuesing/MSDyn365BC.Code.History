codeunit 90 "Purch.-Post"
{
    ...
    begin
        ...
        if PurchHeader.Invoice then
            PostGLAndVendor(PurchHeader, TempPurchLineGlobal, TempInvoicePostBuffer, LineCount);

        OnAfterPostGLAndVendor(PurchHeader, PurchRcptHeader, ReturnShptHeader, PurchInvHeader, PurchCrMemoHeader);
        ...
        with PurchLine do begin
            ...
            if "IRS 1099 Liable" then
                if "Document Type" in ["Document Type"::"Return Order", "Document Type"::"Credit Memo"] then
                    TotalAmount1099 -= xPurchLine."Amount Including VAT"
                else
                    TotalAmount1099 += xPurchLine."Amount Including VAT";
            ...
            OnPostPurchLineOnAfterPostByType(PurchHeader, PurchLine, GenJnlPostLine);
    ...
    begin
        ...
        with PurchHeader do begin
            ...
            if TaxOption = TaxOption::SalesTax then
                if "Tax Area Code" <> '' then begin
                    PostSalesTaxToGL(PurchHeader, PurchLine, LineCount, TotalUseTaxAmount, TotalNotUseTaxAmount);
                    if Invoice then
                        TaxAmountDifference.ClearDocDifference(TaxAmountDifference."Document Product Area"::Purchase, "Document Type".AsInteger(), "No.");
    ...
    local procedure PostSalesTaxToGL(PurchHeader: Record "Purchase Header"; PurchLine: Record "Purchase Line"; LineCount: Integer; var TotalUseTaxAmount: Decimal; var TotalNotUseTaxAmount: Decimal)
    var
        ...
        if TempSalesTaxAmtLine.Find('-') then begin
            repeat
                ...
                then begin
                    ...
                    OnPostSalesTaxToGLOnAfterGenJnlLineAssignField(GenJnlLine, PurchHeader, PurchLine);
    ...
    local procedure PostInvoicePostBufferLine(PurchHeader: Record "Purchase Header"; PurchLine: Record "Purchase Line"; InvoicePostBuffer: Record "Invoice Post. Buffer") GLEntryNo: Integer
    var
        GenJnlLine: Record "Gen. Journal Line";
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterPostGLAndVendor(var PurchaseHeader: Record "Purchase Header"; var PurchRcptHeader: Record "Purch. Rcpt. Header"; var ReturnShipmentHeader: Record "Return Shipment Header"; var PurchInvHeader: Record "Purch. Inv. Header"; var PurchCrMemoHdr: Record "Purch. Cr. Memo Hdr.")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnPostPurchLineOnAfterPostByType(PurchHeader: Record "Purchase Header"; var PurchLine: Record "Purchase Line"; var GenJnlPostLine: Codeunit "Gen. Jnl.-Post Line")
    begin
    end;
