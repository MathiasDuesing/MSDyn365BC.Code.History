codeunit 90 "Purch.-Post"
{
    ...
    begin
        ...
        if PurchHeader.Invoice then
            PostGLAndVendor(PurchHeader, TempInvoicePostBuffer, CVLedgEntryBuf);
    ...
    local procedure PostPurchLine(var PurchHeader: Record "Purchase Header"; var PurchLine: Record "Purchase Line"; var TempInvoicePostBuffer: Record "Invoice Post. Buffer" temporary; var TempVATAmountLine: Record "VAT Amount Line" temporary; var TempVATAmountLineRemainder: Record "VAT Amount Line" temporary; var TempDropShptPostBuffer: Record "Drop Shpt. Post. Buffer" temporary; var EverythingInvoiced: Boolean; var ICGenJnlLineNo: Integer; var TempEmplPurchLine: Record "Purchase Line" temporary)
    var
    ...
    local procedure PostGLAndVendor(var PurchHeader: Record "Purchase Header"; var TempInvoicePostBuffer: Record "Invoice Post. Buffer" temporary; var CVLedgEntryBuf: Record "CV Ledger Entry Buffer")
    var
