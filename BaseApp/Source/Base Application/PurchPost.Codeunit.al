codeunit 90 "Purch.-Post"
{
        ...
        if TempInvoicePostBuffer.Find('+') then
            repeat
                ...
                if Split then
                    ...
                    OnBeforePostInvPostBuffer(GenJnlLine, TempInvoicePostBuffer, PurchHeader, GenJnlPostLine, PreviewMode, SuppressCommit);
    ...
    [IntegrationEvent(false, false)]
    local procedure OnUpdatePostingNosOnBeforeCheckExternalDocNo(var VendLedgEntry: Record "Vendor Ledger Entry"; PostingDate: Date)
    begin
    end;
