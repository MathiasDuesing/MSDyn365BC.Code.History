codeunit 90 "Purch.-Post"
{
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            "Org. Pmt. Disc. Possible (LCY)" :=
              CurrExchRate.ExchangeAmtFCYToLCY(
                Usedate, PurchHeader."Currency Code", -TotalPurchLine2."Pmt. Discount Amount", PurchHeader."Currency Factor");
        end;
    end;
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            "Org. Pmt. Disc. Possible (LCY)" :=
              CurrExchRate.ExchangeAmtFCYToLCY(
                Usedate, PurchHeader."Currency Code", TotalPurchLine."Pmt. Discount Amount", PurchHeader."Currency Factor");
