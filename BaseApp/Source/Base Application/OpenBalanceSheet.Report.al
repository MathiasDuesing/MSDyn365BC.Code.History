...
report 11785 "Open Balance Sheet"
{
        ...
        dataitem("G/L Account"; "G/L Account")
        {
                    ...
                    if EntryNoAmountBuf.Find('-') then
                        repeat
                            if (EntryNoAmountBuf.Amount <> 0) or (EntryNoAmountBuf.Amount2 <> 0) then begin
                                ...
                                GenJnlLine."Source Code" := SourceCodeSetup."Open Balance Sheet";
                                ...
                                if PostToOpeningBalanceSheetAcc = PostToOpeningBalanceSheetAcc::Details then begin
                                    ...
                                    GenJnlLine."Bal. Account No." := OpeningBalanceSheetGLAcc."No.";
                                end;
            ...
            begin
                ...
                then begin
                    ...
                    GenJnlLine."Shortcut Dimension 2 Code" := '';
                    GenJnlLine."Line No." := GenJnlLine."Line No." + 10000;
                    GenJnlLine."Account No." := OpeningBalanceSheetGLAcc."No.";
                    GenJnlLine."Source Code" := SourceCodeSetup."Open Balance Sheet";
                    GenJnlLine."Reason Code" := GenJnlBatch."Reason Code";
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field("OpeningBalanceSheetGLAcc.""No."""; OpeningBalanceSheetGLAcc."No.")
                    {
                        ApplicationArea = Basic, Suite;
                        ...
                        trigger OnValidate()
                        begin
                            if OpeningBalanceSheetGLAcc."No." <> '' then begin
                                OpeningBalanceSheetGLAcc.Find;
                                OpeningBalanceSheetGLAcc.CheckGLAcc;
                            end;
                        end;
                    }
                    field(PostToOpeningBalanceSheetAcc; PostToOpeningBalanceSheetAcc)
                    {
                        ApplicationArea = Basic, Suite;
                    ...
                    group("Open by")
                    {
                        ...
                        field(ColumnDim; ColumnDim)
                        {
                            ...
                            begin
                                DimSelectionBuf.SetDimSelectionMultiple(3, REPORT::"Open Balance Sheet", ColumnDim);
                            end;
                        }
                    }
                }
        ...
        begin
            if PostingDescription = '' then
                PostingDescription :=
                  CopyStr(ObjTransl.TranslateObject(ObjTransl."Object Type"::Report, REPORT::"Open Balance Sheet"), 1, 30);
            EndDateReq := 0D;
            ...
            ValidateJnl;
            ColumnDim := DimSelectionBuf.GetDimSelectionText(3, REPORT::"Open Balance Sheet", '');
        end;
    }
    ...
    var
        ...
        OpeningBalanceSheetGLAcc: Record "G/L Account";
        ...
        Text002: Label 'Please enter Opening Balance Sheet Account No.';
        ...
        Text014: Label 'The fiscal year must be closed before the balance sheet can be opened.';
