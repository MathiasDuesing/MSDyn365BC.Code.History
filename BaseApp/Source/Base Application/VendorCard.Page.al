    ...
    layout
    {
        area(content)
        {
            ...
            group(Invoicing)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the federation-wide organizational classification associated with the vendor.';
                }
                field("OKONX Code"; "OKONX Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the federation-wide national economy sector associated with the vendor.';
                }
            ...
            group(Customer)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the customer number associated with the vendor.';
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the customer name associated with the vendor.';
                    Visible = CustomerNameVisible;
                }
                field(CustomerBalance; Cust."Balance (LCY)")
                {
                    ApplicationArea = All;
                ...
                field(TotalBalance; Cust."Balance (LCY)" - "Balance (LCY)")
                {
                    ApplicationArea = All;
            ...
            {
                Caption = 'VAT Agent';
                field(Control1210004; "VAT Agent")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the VAT agent associated with the vendor.';
                }
                field("VAT Agent Type"; "VAT Agent Type")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the VAT agent type associated with the vendor.';
                }
                field("VAT Payment Source Type"; "VAT Payment Source Type")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the VAT payment source type associated with the vendor.';
                }
                field("VAT Agent Prod. Posting Group"; "VAT Agent Prod. Posting Group")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the VAT agent product posting group associated with the vendor.';
                }
                field("Tax Authority No."; "Tax Authority No.")
                {
                    ApplicationArea = Basic, Suite;
                    LookupPageID = "Tax Authorities";
                    ToolTip = 'Specifies the tax authority number associated with the vendor.';
                }
            }
            group(Payments)
            {
