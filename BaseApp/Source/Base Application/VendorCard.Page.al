    ...
    layout
    {
        area(content)
        {
            ...
            group("Free Lance Fee")
            {
                ...
                field("Soc. Sec. Company Base"; "Soc. Sec. Company Base")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = false;
                ...
                field("INAIL Company Base"; "INAIL Company Base")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = false;
            ...
            group(Receiving)
            {
                ...
                field("Linked to Work Center"; "Linked to Work Center")
                {
                    ApplicationArea = Basic, Suite;
        ...
        area(navigation)
        {
            ...
            group("&Balance")
            {
                ...
                action("&Aging")
                {
                    ...
                    Caption = '&Aging';
                    Image = Aging;
                    RunObject = Page "Vendor Aging";
                    ToolTip = 'Opens the Vendor Aging report so you can see a list of amounts that will be due for payment to individual vendors in the future.';
                }
                separator(Action1130043)
                {
                }
                action("Pa&yment days")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Pa&yment days';
                    Image = PaymentDays;
                    RunObject = Page "Fixed Due Dates";
                    RunPageLink = Type = CONST(Vendor),
                                  Code = FIELD("No.");
                    ToolTip = 'View the releated pa&yment days.';
                }
