table 5624 "FA Reclass. Journal Line"
{
    ...
    fields
    {
        ...
        field(12402; "New Depreciation Book Code"; Code[10])
        {
        ...
        field(12412; "FA Posting Group"; Code[20])
        {
            Caption = 'FA Posting Group';
            TableRelation = "FA Posting Group";
        }
        field(12413; "New FA Posting Group"; Code[20])
        {
        ...
        field(12414; "Duplicate to Journal"; Boolean)
        {
            Caption = 'Duplicate to Journal';
        }
        field(12415; "Copy to Depreciation Book Code"; Code[20])
        {
            Caption = 'Copy to Depreciation Book Code';
        }
        field(12416; Quantity; Integer)
        {
            Caption = 'Quantity';
