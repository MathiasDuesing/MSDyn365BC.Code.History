...
page 9082 "Customer Statistics FactBox"
{
    ...
    layout
    {
        area(content)
        {
            ...
            field("Bill-To No. of Open. Adv. L."; Rec."Bill-To No. of Open. Adv. L.")
            {
                ApplicationArea = Basic, Suite;
            ...
            field("Bill-To No. of P.Pay. Adv. L."; Rec."Bill-To No. of P.Pay. Adv. L.")
            {
                ApplicationArea = Basic, Suite;
            ...
            field("Bill-To No. of P.Inv. Adv. L."; Rec."Bill-To No. of P.Inv. Adv. L.")
            {
                ApplicationArea = Basic, Suite;
            ...
            field("Bill-To No. of P.F.Inv.Adv. L."; Rec."Bill-To No. of P.F.Inv.Adv. L.")
            {
                ApplicationArea = Basic, Suite;
