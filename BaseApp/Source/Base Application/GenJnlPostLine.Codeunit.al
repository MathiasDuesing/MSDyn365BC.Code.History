        ...
        with GenJnlLine do begin
            ...
            if "Amount (LCY)" <> 0 then
                if "System-Created Entry" then begin
                    CVLedgEntryBuf."Original Pmt. Disc. Possible" := Round("Orig. Pmt. Disc. Possible", AmountRoundingPrecision);
                    CVLedgEntryBuf."Orig. Pmt. Disc. Possible(LCY)" := Round("Orig. Pmt. Disc. Possible(LCY)");
                    CVLedgEntryBuf."Remaining Pmt. Disc. Possible" := CVLedgEntryBuf."Original Pmt. Disc. Possible";
#if not CLEAN20
                    CVLedgEntryBuf."Org. Pmt. Disc. Possible (LCY)" := CVLedgEntryBuf."Orig. Pmt. Disc. Possible(LCY)";
#endif
                end else
