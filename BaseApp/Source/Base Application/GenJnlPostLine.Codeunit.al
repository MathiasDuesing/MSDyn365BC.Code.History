codeunit 12 "Gen. Jnl.-Post Line"
{
    ...
    local procedure CreateVendGLEntriesForTotalAmounts(GenJnlLine: Record "Gen. Journal Line"; var InvPostBuf: Record "Invoice Post. Buffer"; VendPostingGr: Record "Vendor Posting Group"; AdjAmountBuf: array[4] of Decimal; SavedEntryNo: Integer; LedgEntryInserted: Boolean)
    var
        GLEntry: Record "G/L Entry";
        DimMgt: Codeunit DimensionManagement;
    begin
