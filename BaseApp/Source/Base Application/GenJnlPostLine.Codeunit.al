codeunit 12 "Gen. Jnl.-Post Line"
{
        ...
        with GenJnlLine do begin
            ...
            if "Gen. Posting Type" <> "Gen. Posting Type"::" " then begin
                ...
                if (not GLSetup."Unrealized VAT") and (VATEntry.Type <> VATEntry.Type::Settlement) then begin
                    ...
                    VATEntry."Amount (FCY)" := "Source Curr. VAT Amount";
                    VATEntry."Base (FCY)" := "Source Curr. VAT Base Amount";
                    VATEntry."Currency Factor" := "Currency Factor";
                    if VATPostingSetup."VAT Calculation Type" = "VAT Calculation Type"::"Reverse Charge VAT" then begin
                        GetCurrency(Currency, "Currency Code");
                        VATEntry."VAT %" := VATPostingSetup."VAT %";
                        if (not "System-Created Entry") and (VATEntry."Amount (FCY)" = 0) then
                            VATEntry."Amount (FCY)" := Round(Amount * VATEntry."VAT %" / 100, Currency."Amount Rounding Precision");
                    end else
                        VATEntry."VAT %" := "VAT %";
    ...
    begin
        ...
        if not (GLAcc."Currency Code" in ['', GLSetup."LCY Code"]) and
           ...
           not (GenJnlLine."Additional-Currency Posting" =
    ...
    begin
        ...
        with GenJnlLine do
            if "Amount (LCY)" <> 0 then begin
                ...
                CVLedgEntryBuf."Original Pmt. Disc. Possible" :=
                  GLSetup.RoundPmtDiscLCY(Amount, CVLedgEntryBuf."Original Pmt. Disc. Possible", "Currency Code");
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            "Currency Factor" := CustLedgEntryPostApply."Original Currency Factor";
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            "Currency Factor" := VendLedgEntryPostApply."Original Currency Factor";
