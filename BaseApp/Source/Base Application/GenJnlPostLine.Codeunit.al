codeunit 12 "Gen. Jnl.-Post Line"
{
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            SetBASFields(VATEntry, "BAS Doc. No.", "BAS Version", "BAS Adjustment");
    ...
    begin
        ...
        CreateVendGLEntriesForTotalAmounts(
          GenJnlLine, TempDimPostingBuffer, VendPostingGr, AdjAmount, SaveEntryNo, LedgEntryInserted);
    ...
    begin
        UnapplyVendLedgEntry(GenJnlLine2, DtldVendLedgEntry, false);
    end;

    procedure UnapplyVendLedgEntry(GenJnlLine2: Record "Gen. Journal Line"; DtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry"; VoidCheck: Boolean)
    var
        Vend: Record Vendor;
        VendPostingGr: Record "Vendor Posting Group";
        GenJnlLine: Record "Gen. Journal Line";
    ...
    local procedure GLCalcAddCurrency(Amount: Decimal; AddCurrAmount: Decimal; OldAddCurrAmount: Decimal; UseAddCurrAmount: Boolean; GenJnlLine: Record "Gen. Journal Line"; var UseVendExchRateCheck: Boolean) Result: Decimal
    var
        PurchSetup: Record "Purchases & Payables Setup";
        IsHandled: Boolean;
    begin
