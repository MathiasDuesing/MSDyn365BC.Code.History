codeunit 12 "Gen. Jnl.-Post Line"
{
        ...
        with GenJnlLine do begin
            ...
            if AddCurrencyCode <> '' then
                if AddCurrencyCode <> SrcCurrCode then begin
                    ...
                    "Non Ded. Source Curr. VAT Amt." := ExchangeAmtLCYToFCY2("Non Ded. VAT Amount");
                end else
            ...
            if "Gen. Posting Type" <> "Gen. Posting Type"::" " then begin
                ...
                VATEntry."Journal Template Name" := "Journal Template Name";
                ...
                VATEntry."Non Ded. VAT Amount" := "Non Ded. VAT Amount";
                VATEntry."Non Ded. Source Curr. VAT Amt." := "Non Ded. Source Curr. VAT Amt.";
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            if (GLEntryVATAmountNotEmpty or ("Non Ded. VAT Amount" <> 0)) or
                            ...
                            VATPostingSetup."VAT Calculation Type"::"Reverse Charge VAT":
                                begin
                                    ...
                                    OnInsertVATOnBeforeCreateGLEntryForReverseChargeVATToRevChargeAcc(
                                      GenJnlLine, VATPostingSetup, UnrealizedVAT, GLEntryVATAmount, SrcCurrGLEntryVATAmt, true);
                                    CreateGLEntry(
                                      GenJnlLine, VATPostingSetup.GetRevChargeAccount(UnrealizedVAT),
                                      -GLEntryVATAmount - "Non Ded. VAT Amount", -SrcCurrGLEntryVATAmt - "Non Ded. Source Curr. VAT Amt.", true);
                                end;
    ...
    begin
        ...
        if not IsHandled then
            with GenJnlLine do begin
                ...
                GLEntry."Journal Template Name" := "Journal Template Name";
            ...
            if "Amount (LCY)" <> 0 then
                if "System-Created Entry" then begin
                    CVLedgEntryBuf."Original Pmt. Disc. Possible" :=
                      Round("Original Pmt. Disc. Possible", AmountRoundingPrecision);
    ...
    begin
        ...
        TempVATEntry."Journal Template Name" := GenJnlLine."Journal Template Name";
    ...
    begin
        ...
        VATEntry."Journal Template Name" := GenJnlLine."Journal Template Name";
        ...
        with GenJournalLine do begin
            ...
            if DeferralLine.FindSet() then begin
                ...
                repeat
                    ...
                    CheckDeferralPostingDate(PerPostDate, GenJournalLine);
    ...
    local procedure CheckDeferralPostingDate(PostingDate: Date; GenJournalLine: Record "Gen. Journal Line")
    var
        IsHandled: Boolean;
    begin
        IsHandled := false;
    ...
    if GenJnlCheckLine.DateNotAllowed(PostingDate, GenJournalLine."Journal Template Name") then
            ...
            with GenJournalLine do begin
                ...
                if DeferralPostBuffer.FindSet() then begin
                    repeat
                        ...
                        if GenJnlCheckLine.DateNotAllowed(PostDate, "Journal Template Name") then
