codeunit 12 "Gen. Jnl.-Post Line"
{
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            UnrealizedVAT :=
              ...
              (IsNotPayment("Document Type") or ("Document Type" = "Document Type"::Bill));
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            // Post application
            OnPostCustOnBeforeApplyCustLedgEntry(GenJnlLine, CVLedgEntryBuf, FromBillSettlement);
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            OriginalEntryExist := IsOriginalEntryExist(GenJnlLine);
            // Post application
            OnPostVendOnBeforeApplyVendLedgEntry(GenJnlLine, CVLedgEntryBuf, FromBillSettlement);
    ...
    begin
        ...
        repeat
            ...
            if (OldCustLedgEntry."Document Type" = OldCustLedgEntry."Document Type"::Bill) or
               (OldCustLedgEntry."Document Situation" <> 0)
            then begin
    ...
    begin
        ...
        if (NewCustLedgEntry."Document Type" = NewCustLedgEntry."Document Type"::Bill) or
           (NewCustLedgEntry."Document Situation" <> 0)
        then begin
    ...
    begin
        ...
        if GenJnlLine."Applies-to Doc. No." <> '' then begin
            ...
            OldCustLedgEntry.Reset();
            OldCustLedgEntry.SetLoadFields("Posting Date", "Currency Code", "Document Situation");
    ...
    begin
        ...
        repeat
            ...
            if (OldVendLedgEntry."Document Type" = OldVendLedgEntry."Document Type"::Bill) or
               (OldVendLedgEntry."Document Situation" <> 0)
            then begin
    ...
    begin
        ...
        if (NewVendLedgEntry."Document Type" = NewVendLedgEntry."Document Type"::Bill) or
           (NewVendLedgEntry."Document Situation" <> 0)
        then begin
    ...
    begin
        ...
        if GenJnlLine."Applies-to Doc. No." <> '' then begin
            ...
            // Find the first old entry (Invoice) which the new entry (Payment) should apply to
            OldVendLedgEntry.Reset();
            OldVendLedgEntry.SetLoadFields("Posting Date", "Currency Code", "Document Situation");
    ...
    begin
        ...
        if DtldCVLedgEntryBuf.FindSet() then begin
            ...
            AccNo := GetVendCarteraAccountNo(GenJnlLine, VendPostingGr);
        ...
        CreateGLEntriesForTotalAmounts(
            GenJnlLine, TempDimPostingBuffer, AdjAmount, SaveEntryNo, GetVendorPayablesAccount(GenJnlLine, VendPostingGr));
    ...
    begin
        ...
        CreateGLEntriesForTotalAmounts(
          GenJnlLine, TempDimPostingBuffer, DummyAdjAmount, SaveEntryNo, EmplPostingGr.GetPayablesAccount());
    ...
    local procedure CheckCarteraAccessPermissions(DocumentSituation: Option " ","Posted BG/PO","Closed BG/PO","BG/PO",Cartera,"Closed Documents")
    begin
