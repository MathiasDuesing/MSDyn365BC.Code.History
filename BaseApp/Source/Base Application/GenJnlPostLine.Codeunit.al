codeunit 12 "Gen. Jnl.-Post Line"
{
    ...
    local procedure GLCalcAddCurrency(Amount: Decimal; AddCurrAmount: Decimal; OldAddCurrAmount: Decimal; UseAddCurrAmount: Boolean; GenJnlLine: Record "Gen. Journal Line"; UseVendExchRateCheck: Boolean) Result: Decimal
    var
        PurchSetup: Record "Purchases & Payables Setup";
        IsHandled: Boolean;
    begin
