        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Prepmt. CM Refers to Period"; "Prepmt. CM Refers to Period")
                {
                    ...
                    ToolTip = 'Specifies the time period that is spent to process and filter the prepayment credit memo transactions.';
                }
                field("Refers to Period"; "Refers to Period")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the time period that is spent to process and filter the transactions.';
                }
