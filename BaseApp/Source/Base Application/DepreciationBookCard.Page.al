    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the posting book type associated with the depreciation book.';
                }
                ...
                field("Allow Depreciation"; Rec."Allow Depreciation")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies if the depreciation book allows for depreciations.';
                }
                ...
                field("Mark Errors as Corrections"; Rec."Mark Errors as Corrections")
                {
                    ApplicationArea = FixedAssets;
                ...
                field("Control FA Acquis. Cost"; Rec."Control FA Acquis. Cost")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies if the depreciation book controls fixed asset acquisition costs.';
                }
            }
            group(Integration)
            {
