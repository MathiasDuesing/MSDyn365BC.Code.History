    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Compress Depreciation"; Rec."Compress Depreciation")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies that the system will compress multiple depreciation lines in the General Ledger, the result will be a single entry for each category.';
                }
                ...
                field("Anticipated Depreciation Calc."; Rec."Anticipated Depreciation Calc.")
                {
                    ApplicationArea = FixedAssets;
                    Caption = 'Calc. Anticipated Depreciation';
                    ToolTip = 'Specifies if an anticipated depreciation should be calculated during the depreciation process.';
                }
                field("Acc./Red. Depreciation Calc."; Rec."Acc./Red. Depreciation Calc.")
                {
                    ApplicationArea = FixedAssets;
