    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Allow more than 360/365 Days"; "Allow more than 360/365 Days")
                {
                    ApplicationArea = FixedAssets;
                ...
                field("Use Rounding in Periodic Depr."; "Use Rounding in Periodic Depr.")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies whether the calculated periodic depreciation amounts should be rounded to whole numbers.';
                }
                field("Use Same FA+G/L Posting Dates"; "Use Same FA+G/L Posting Dates")
                {
                    ApplicationArea = FixedAssets;
                ...
                field("Fiscal Year 365 Days"; "Fiscal Year 365 Days")
                {
                    ApplicationArea = FixedAssets;
            ...
            group(Integration)
            {
                ...
                group("G/L Integration")
                {
                    ...
                    field("G/L Integration - Acq. Cost"; "G/L Integration - Acq. Cost")
                    {
                        ApplicationArea = FixedAssets;
                    ...
                    field("G/L Integration - Depreciation"; "G/L Integration - Depreciation")
                    {
                        ApplicationArea = FixedAssets;
                    ...
                    field("G/L Integration - Write-Down"; "G/L Integration - Write-Down")
                    {
                        ApplicationArea = FixedAssets;
                    ...
                    field("G/L Integration - Appreciation"; "G/L Integration - Appreciation")
                    {
                        ApplicationArea = FixedAssets;
                    ...
                    field("G/L Integration - Custom 1"; "G/L Integration - Custom 1")
                    {
                        ApplicationArea = FixedAssets;
                    ...
                    field("G/L Integration - Custom 2"; "G/L Integration - Custom 2")
                    {
                        ApplicationArea = FixedAssets;
                    ...
                    field("G/L Integration - Disposal"; "G/L Integration - Disposal")
                    {
                        ApplicationArea = FixedAssets;
                    ...
                    field("G/L Integration - Maintenance"; "G/L Integration - Maintenance")
                    {
                        ApplicationArea = FixedAssets;
            ...
            {
                Caption = 'Duplication';
                field("Part of Duplication List"; "Part of Duplication List")
                {
                    ApplicationArea = FixedAssets;
                ...
                field("Use FA Exch. Rate in Duplic."; "Use FA Exch. Rate in Duplic.")
                {
                    ApplicationArea = FixedAssets;
                ...
                field("Default Exchange Rate"; "Default Exchange Rate")
                {
                    ApplicationArea = FixedAssets;
            ...
            group(Reporting)
            {
                ...
                group("Use Add.-Curr Exch. Rate")
                {
                    ...
                    field("Add-Curr Exch Rate - Acq. Cost"; "Add-Curr Exch Rate - Acq. Cost")
                    {
                    ...
                    field("Add-Curr. Exch Rate - Custom 1"; "Add-Curr. Exch Rate - Custom 1")
                    {
                        ApplicationArea = Suite;
                        Caption = 'Custom 1';
