    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Use Custom 1 Depreciation"; Rec."Use Custom 1 Depreciation")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies if you want to use depreciation of Custom 1 entries, so that you can define how to handle custom 1 depreciation in the FA depreciation book.';
                }
