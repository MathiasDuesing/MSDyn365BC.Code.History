    ...
    layout
    {
        area(content)
        {
            ...
            group(Payments)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies how you want the date to appear on the printed check image for this vendor.';
                }
                field("Check Date Separator"; "Check Date Separator")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the character that you want to separate Month, Day and Year, for the date that prints on the check image.';
                }
            }
        }
    }
