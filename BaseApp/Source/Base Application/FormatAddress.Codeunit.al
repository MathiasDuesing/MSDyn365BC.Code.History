codeunit 365 "Format Address"
{
    ...
    [Scope('OnPrem')]
    procedure TaxOffice(var AddrArray: array[8] of Text[100]; var CompanyInfo: Record "Company Information")
    begin
        with CompanyInfo do
            FormatAddr(
              AddrArray, "Tax Office Name", "Tax Office Name 2", '', "Tax Office Address", "Tax Office Address 2",
              "Tax Office City", "Tax Office Post Code", "Tax Office County", "Tax Office Country/Region Code");
    end;
