            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem(CopyLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(VATAmountLine__VAT_Calculation_Type_; VATAmountLine."VAT Calculation Type")
                        {
                        }
                        ...
                        column(VATAmountLine_VATAmountText_Control1100013; VATAmountLine.VATAmountText)
                        {
                        }
                    ...
                    dataitem(VATCounter; "Integer")
                    {
                        ...
                        column(VATAmountLine__Invoice_Discount_Amount___VATAmountLine__Pmt__Disc__Given_Amount_; VATAmountLine."Invoice Discount Amount" + VATAmountLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__Invoice_Discount_Amount__Control177; VATAmountLine."Invoice Discount Amount" + VATAmountLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(EC__; VATAmountLine."EC %")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmountLine__EC_Amount__Control1100007; VATAmountLine."EC Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__VAT_EC_Base__Control139; VATAmountLine."VAT Base")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmountLine__Invoice_Discount_Amount___VATAmountLine__Pmt__Disc__Given_Amount__Control181; VATAmountLine."Invoice Discount Amount" + VATAmountLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__Invoice_Discount_Amount__Control187; VATAmountLine."Invoice Discount Amount" + VATAmountLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__EC_Amount__Control1100009; VATAmountLine."EC Amount")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
