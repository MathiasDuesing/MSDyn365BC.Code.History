            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem(CopyLoop; "Integer")
                {
                    ...
                    dataitem(VATCounterACY; "Integer")
                    {
                        ...
                        column(VATAmountLine__VAT_Amount__ACY__; VATAmountLine."VAT Amount (ACY)")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmountLine__VAT_Base__ACY__; VATAmountLine."VAT Base (ACY)")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmountLine__VAT____Control1500006; VATAmountLine."VAT %")
                        {
                            DecimalPlaces = 0 : 5;
                        }
                        column(VATAmountLine__VAT_Identifier__Control1500007; VATAmountLine."VAT Identifier")
                        {
                        }
                        column(VATAmountLine__VAT_Amount__ACY___Control1500008; VATAmountLine."VAT Amount (ACY)")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmountLine__VAT_Base__ACY___Control1500009; VATAmountLine."VAT Base (ACY)")
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
