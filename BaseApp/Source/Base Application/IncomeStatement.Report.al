...
report 11783 "Income Statement"
{
    ...
    dataset
    {
        dataitem(AccScheduleName; "Acc. Schedule Name")
        {
            ...
            dataitem(Heading; "Integer")
            {
                ...
                column(gtcReportCaption; gtcReportCaption)
                {
                }
                ...
                dataitem("Acc. Schedule Line"; "Acc. Schedule Line")
                {
                    ...
                    dataitem(ColumnLayoutLoop; "Integer")
                    {
                        ...
                        begin
                            ...
                            ColumnValuesDisplayed := AccSchedManagement.CalcCell("Acc. Schedule Line", TColLayoutTmp, UseAmtsInAddCurr);
                            if AccSchedManagement.GetDivisionError then begin
                                ...
                                if AccSchedManagement.GetPeriodError then begin
                                    ...
                                    ColumnValuesAsText :=
                                      AccSchedManagement.FormatCellAsText(TColLayoutTmp, ColumnValuesDisplayed, UseAmtsInAddCurr);
    ...
    trigger OnPreReport()
    var
        ltcText000: Label '%1 %2 must be unique!';
    begin
        if AccSchedName = '' then begin
            if AccScheduleName.GetRangeMin(Name) <> AccScheduleName.GetRangeMax(Name) then
                Error(ltcText000, AccScheduleName.TableCaption, AccScheduleName.FieldCaption(Name));
    ...
    var
        ...
        gtcReportCaption: Label 'Income Statement';
