codeunit 229 "Document-Print"
{
    ...
    procedure PrintSalesOrder(SalesHeader: Record "Sales Header"; Usage: Option "Order Confirmation","Work Order","Pick Instruction","Sales Order Picking List")
    var
        ReportSelection: Record "Report Selections";
        ReportUsage: Enum "Report Selection Usage";
        IsPrinted: Boolean;
    ...
    procedure GetSalesOrderUsage(Usage: Option "Order Confirmation","Work Order","Pick Instruction","Sales Order Picking List") Result: Enum "Report Selection Usage"
    var
        ReportSelections: Record "Report Selections";
        IsHandled: Boolean;
    begin
