page 5743 "Posted Transfer Shipment"
{
    ...
    actions
    {
        ...
        area(reporting)
        {
            action("Transfer Shipment TORG-13")
            {
                ...
                RunObject = Report "Transfer Shipment TORG-13";
                ToolTip = 'View posted shipments for items that are transferred within the organization.';
            }
        }
    }
