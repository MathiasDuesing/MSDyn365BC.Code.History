    ...
    layout
    {
        area(content)
        {
            ...
            group("Invoice Details")
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the vendor receipts number associated with the purchase header.';
                }
                field("Vendor Receipts Date"; "Vendor Receipts Date")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the vendor receipts date associated with the purchase header.';
                }
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action("Create Tracking Specification")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Create Tracking Specification';
                    Image = ItemTracking;
