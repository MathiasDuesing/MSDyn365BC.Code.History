codeunit 5605 "Calculate Disposal"
{
    ...
    begin
        with FALedgEntry do begin
            ...
            SetFilter("FA Posting Date", FADeprBook.GetFilter("FA Posting Date Filter"));
            CalcSums(Amount);
            exit(Amount);
        end;
    end;
