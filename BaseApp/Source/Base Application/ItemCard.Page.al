    ...
    layout
    {
        area(content)
        {
            ...
            group(InventoryGrp)
            {
                ...
                field("Gross Weight Mandatory"; Rec."Gross Weight Mandatory")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the gross weight of the item is mandatory.';
                }
                field("Unit Volume Mandatory"; Rec."Unit Volume Mandatory")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the unit volume of an item is mandatory.';
                }
...
#endif
                actionref("Item G/L Turnover_Promoted"; "Item G/L Turnover")
                {
                }
            }
