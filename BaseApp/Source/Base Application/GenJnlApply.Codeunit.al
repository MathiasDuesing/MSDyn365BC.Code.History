    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            if "Prepayment Type" = "Prepayment Type"::Advance then
                ...
                CustLedgEntry.SetFilter("Prepayment Type", '<>%1', "Prepayment Type"::Advance);
            // NAVCZ
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            if "Prepayment Type" = "Prepayment Type"::Advance then
                ...
                VendLedgEntry.SetFilter("Prepayment Type", '<>%1', "Prepayment Type"::Advance);
            // NAVCZ
        ...
        with GenJnlLine do begin
            ...
            if "Applies-to ID" = '' then
                Error(
                  Text000,
                  FieldCaption("Document No."), FieldCaption("Applies-to ID"));
            ApplyGeneralLedgerEntries.SetRecord(GLEntry);
            ApplyGeneralLedgerEntries.SetTableView(GLEntry);
            ApplyGeneralLedgerEntries.SetGenJnlLine(GenJnlLine, FieldNo("Applies-to ID"));
            ApplyGeneralLedgerEntries.LookupMode(true);
            EntrySelected := ApplyGeneralLedgerEntries.RunModal = ACTION::LookupOK;
