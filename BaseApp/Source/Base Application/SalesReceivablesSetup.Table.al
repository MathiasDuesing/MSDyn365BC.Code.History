table 311 "Sales & Receivables Setup"
{
    ...
    fields
    {
        ...
        field(12401; "Posted Prepayment Nos."; Code[20])
        {
            Caption = 'Posted Prepayment Nos.';
            TableRelation = "No. Series";
        }
        ...
        field(12407; "Invoice Comment"; Text[100])
        {
            Caption = 'Invoice Comment';
        }
        field(12409; "Create Prepayment Invoice"; Boolean)
        {
            Caption = 'Create Prepayment Invoice';
        }
        field(12410; "Transfer Posting Description"; Boolean)
        {
            Caption = 'Transfer Posting Description';
        }
        field(12411; "Price Decimal Points"; Integer)
        {
            BlankZero = true;
            Caption = 'Price Decimal Points';
        }
        field(12412; "Price (LCY) Decimal Points"; Integer)
        {
            BlankZero = true;
            Caption = 'Price (LCY) Decimal Points';
        }
        field(12413; "Discount Decimal Points"; Integer)
        {
            BlankZero = true;
            Caption = 'Discount Decimal Points';
        }
        field(12415; "Check Application Period"; Boolean)
        {
            Caption = 'Check Application Period';
        }
        ...
        field(12430; "Calc. VAT per Line"; Boolean)
        {
            Caption = 'Calc. VAT per Line';
        }
        ...
        field(12436; "Posted Corr. Invoice Nos."; Code[20])
        {
            Caption = 'Posted Corr. Invoice Nos.';
            TableRelation = "No. Series";
        }
        field(12437; "Posted Corr. Credit Memo Nos."; Code[20])
        {
            Caption = 'Posted Corr. Credit Memo Nos.';
            TableRelation = "No. Series";
        }
        field(12450; "Job Ticket Template Code"; Code[10])
        {
            Caption = 'Job Ticket Template Code';
            TableRelation = "Excel Template";
        }
        field(12451; "Bill of Lading Template Code"; Code[10])
        {
            Caption = 'Bill of Lading Template Code';
            TableRelation = "Excel Template";
        }
        field(12452; "Factura Template Code"; Code[10])
        {
            Caption = 'Factura Template Code';
            TableRelation = "Excel Template";
        }
        field(12453; "TORG-12 Template Code"; Code[10])
        {
            Caption = 'TORG-12 Template Code';
            TableRelation = "Excel Template";
        }
        field(12454; "Proforma Template Code"; Code[10])
        {
            Caption = 'Proforma Template Code';
            TableRelation = "Excel Template";
        }
        field(12456; "Corr. Factura Template Code"; Code[10])
        {
            Caption = 'Corr. Factura Template Code';
            TableRelation = "Excel Template";
        }
        field(12457; "Sales Shipment M-15 Templ.Code"; Code[10])
        {
            Caption = 'Sales Shipment M-15 Templ.Code';
            TableRelation = "Excel Template";
        }
        field(12490; "Customer Agreement Nos."; Code[20])
        {
            Caption = 'Customer Agreement Nos.';
            TableRelation = "No. Series";
        }
        ...
        field(12492; "Customer Agreement Dim. Code"; Code[20])
        {
            Caption = 'Customer Agreement Dim. Code';
            TableRelation = Dimension;
        }
    }
