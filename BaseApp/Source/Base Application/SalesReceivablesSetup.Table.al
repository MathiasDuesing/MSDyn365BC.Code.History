table 311 "Sales & Receivables Setup"
{
    ...
    fields
    {
        ...
        field(12175; "Temporary Bill List No."; Code[20])
        {
            Caption = 'Temporary Bill List No.';
            TableRelation = "No. Series";
        }
        field(12176; "Recall Bill Description"; Text[50])
        {
            Caption = 'Recall Bill Description';
        }
        ...
        field(12178; "Fattura PA Nos."; Code[20])
        {
            Caption = 'Fattura PA Nos.';
            TableRelation = "No. Series";
        }
        field(12179; "Prevent Posted Doc. Deletion"; Boolean)
        {
            Caption = 'Prevent Posted Doc. Deletion';
            InitValue = true;
        }
        field(12180; "Fattura PA Electronic Format"; Code[20])
        {
            Caption = 'Fattura PA Electronic Format';
            TableRelation = "Electronic Document Format".Code;
        }
        field(12181; "Validate Document On Posting"; Boolean)
        {
            ...
            begin
                if "Validate Document On Posting" then begin
                    TestField("Fattura PA Electronic Format");
                    ElectronicDocumentFormat.Get("Fattura PA Electronic Format", ElectronicDocumentFormat.Usage::"Sales Validation");
                end;
            end;
        }
