table 311 "Sales & Receivables Setup"
{
    ...
    fields
    {
        ...
        {
            Caption = 'KID Setup';
            InitValue = "Document No.";
            OptionCaption = 'Do not use,Document No.,Document No.+Customer No.,Customer No.+Document No.,Document Type+Document No.,Document No.+Document Type';
            OptionMembers = "Do not use","Document No.","Document No.+Customer No.","Customer No.+Document No.","Document Type+Document No.","Document No.+Document Type";
        ...
        field(10604; "Document No. length"; Integer)
        {
            Caption = 'Document No. length';
            InitValue = 10;
        ...
        field(10605; "Customer No. length"; Integer)
        {
            Caption = 'Customer No. length';
        ...
        field(10606; "Use KID on Fin. Charge Memo"; Boolean)
        {
            Caption = 'Use KID on Fin. Charge Memo';
        ...
        field(10607; "Use KID on Reminder"; Boolean)
        {
            Caption = 'Use KID on Reminder';
    ...
    var
        ...
        Text1080003: Label 'Notice: Document No. can be up to %1 digits.';
        Text1080004: Label 'Notice: Customer No. can be up to %1 digits.';
