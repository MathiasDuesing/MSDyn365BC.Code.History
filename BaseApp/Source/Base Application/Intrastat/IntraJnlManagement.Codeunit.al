codeunit 350 IntraJnlManagement
{
    ...
    begin
        ...
        CreateAdvancedChecklistSetupCommonFields(Report::"Intrastat - Make Declaration");

        CreateAdvancedChecklistFieldSetup(Report::"Intrastat - Checklist", IntrastatJnlLine.FieldNo("Transport Method"), '');
