    ...
    actions
    {
        ...
        area(Promoted)
        {
            group(Category_Process)
            {
                ...
                actionref(Proposal_Navigate_Promoted; Proposal_Navigate)
                {
                }
                actionref(GetProposalEntries_Promoted; GetProposalEntries)
                {
                }
                actionref(PaymentHistory_Promoted; PaymentHistory)
                {
                }
            }
