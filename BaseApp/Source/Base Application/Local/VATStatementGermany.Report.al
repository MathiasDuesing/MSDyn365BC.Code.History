...
#if not CLEAN21
    [Scope('OnPrem')]
    [Obsolete('InitializeRequest(var NewVATStatementName: Record "VAT Statement Name"; var NewVATStatementLine: Record "VAT Statement Line"; NewSelection: Enum "VAT Statement Report Selection"; NewPeriodSelection: Enum "VAT Statement Report Period Selection"; NewVATDateType: Enum "VAT Date Type"; NewPrintInIntegers: Boolean; NewUseAmtsInAddCurr: Boolean)','21.0')]
