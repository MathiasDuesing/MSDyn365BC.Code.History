table 39 "Purchase Line"
{
    ...
    keys
    {
        ...
        {
            MaintainSQLIndex = false;
            SumIndexFields = Amount, "Amount Including VAT", "VAT Base Amount";
        }
                    ...
                    "VAT Calculation Type"::"Reverse Charge VAT":
                        begin
                            ...
                            if "VAT %" <> 0 then
                                "VAT Base Amount" :=
                                  Round(
                                    (TotalAmount + Amount) * (1 - PurchHeader."VAT Base Discount %" / 100),
                                    Currency."Amount Rounding Precision") -
                                  TotalVATBaseAmount
                            else
                                "VAT Base Amount" := Amount;
                                ...
                                if PurchHeader."Prices Including VAT" then begin
                                    ...
                                    if ("VAT %" <> 0) and (VATAmountLine.CalcLineAmount <> 0) then
                                        NewVATBaseAmount :=
                                          ...
                                          VATAmountLine."VAT Base" * (1 - PurchHeader."VAT Base Discount %" / 100) *
    ...
    begin
        GetPurchHeader;
        exit(PurchHeader."Journal Template Name");
    end;
