...
#pragma warning restore
    ...
    keys
    {
        ...
        key(Key17; "Recalculate Invoice Disc.")
        {
        }
        key(Key18; "Outstanding Quantity")
        {
        }
        key(Key19; "Location Code", "Quantity Invoiced")
        {
        }
        key(Key20; "Completely Received")
        {
        }
    }
