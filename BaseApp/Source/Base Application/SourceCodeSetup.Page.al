    ...
    layout
    {
        area(content)
        {
            ...
            group(Sales)
            {
                ...
                field("Customer Prepayments"; Rec."Customer Prepayments")
                {
                    ApplicationArea = Prepayments;
                    ToolTip = 'Specifies the source code for the customer prepayments.';
                }
                field("VAT for Customer Adjustment"; Rec."VAT for Customer Adjustment")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group(Purchases)
            {
                ...
                field("Vendor Prepayments"; Rec."Vendor Prepayments")
                {
                    ApplicationArea = Prepayments;
                    ToolTip = 'Specifies the source code for the vendor prepayments.';
                }
                field("Advance Statements"; Rec."Advance Statements")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the source code for the advance statements.';
                }
                field("VAT for Vendor Adjustment"; Rec."VAT for Vendor Adjustment")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the source code for the VAT for vendor adjustments.';
                }
                field("VAT Allocation on Cost"; Rec."VAT Allocation on Cost")
                {
                    ApplicationArea = Basic, Suite;
