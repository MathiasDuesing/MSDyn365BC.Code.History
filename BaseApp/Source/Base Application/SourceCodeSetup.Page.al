    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Bank Payments"; "Bank Payments")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the source code for bank payment orders.';
                }
                field("Bank Reconciliations"; "Bank Reconciliations")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the source code for bank reconciliations.';
                }
                field("Cash Order Payments"; "Cash Order Payments")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the source code for the cash order payments.';
                }
                field("Tax Difference Journal"; "Tax Difference Journal")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group(Sales)
            {
                ...
                field("Customer Prepayments"; "Customer Prepayments")
                {
                    ApplicationArea = Prepayments;
                    ToolTip = 'Specifies the source code for the customer prepayments.';
                }
                field("VAT for Customer Adjustment"; "VAT for Customer Adjustment")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the source code for the VAT for customer adjustments.';
                }
            ...
            group(Purchases)
            {
                ...
                field("Vendor Prepayments"; "Vendor Prepayments")
                {
                    ApplicationArea = Prepayments;
                    ToolTip = 'Specifies the source code for the vendor prepayments.';
                }
                field("Advance Statements"; "Advance Statements")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the source code for the advance statements.';
                }
                field("VAT for Vendor Adjustment"; "VAT for Vendor Adjustment")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the source code for the VAT for vendor adjustments.';
                }
                field("VAT Allocation on Cost"; "VAT Allocation on Cost")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the source code for the VAT allocation on cost.';
                }
            ...
            group("Fixed Assets")
            {
                ...
                field("Deferred VAT Settlement"; "Deferred VAT Settlement")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the source code for the deferred VAT settlement.';
                }
                field("FA Release"; "FA Release")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the source code for the fixed asset release.';
                }
                field("FA Movement"; "FA Movement")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the source code for the fixed assets movement.';
                }
                field("FA Writeoff"; "FA Writeoff")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the source code for the fixed asset write-off.';
                }
