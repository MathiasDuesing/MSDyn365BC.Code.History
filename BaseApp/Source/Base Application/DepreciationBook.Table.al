table 5611 "Depreciation Book"
{
    ...
    fields
    {
        ...
        {
            AccessByPermission = TableData Currency = R;
            Caption = 'Add-Curr. Exch Rate - Antic.';
        }
        field(39; "Add-Curr. Exch Rate - Custom 2"; Boolean)
        {
            AccessByPermission = TableData Currency = R;
            Caption = 'Add-Curr. Exch Rate - Accel.';
        }
        ...
        field(12101; "Anticipated Depreciation Calc."; Boolean)
        {
            Caption = 'Anticipated Depreciation Calc.';
        }
        field(12102; "Acc./Red. Depreciation Calc."; Boolean)
        {
            Caption = 'Acc./Red. Depreciation Calc.';
        }
    }
