table 5611 "Depreciation Book"
{
    ...
    fields
    {
        ...
        field(12400; "Currency Code"; Code[10])
        {
            Caption = 'Currency Code';
            TableRelation = Currency;
        }
        field(12401; "Posting Book Type"; Option)
        {
            Caption = 'Posting Book Type';
            OptionCaption = ' ,Accounting,Tax Accounting,Analytical';
            OptionMembers = " ",Accounting,"Tax Accounting",Analytical;
        }
        field(12402; "Allow Depreciation"; Boolean)
        {
            Caption = 'Allow Depreciation';
        }
        field(12403; "Control FA Acquis. Cost"; Boolean)
        {
            Caption = 'Control FA Acquis. Cost';
