report 7305 "Whse.-Source - Create Document"
{
    ...
    dataset
    {
        ...
        dataitem("Whse. Mov.-Worksheet Line"; "Whse. Worksheet Line")
        {
            ...
            trigger OnAfterGetRecord()
            begin
                if FEFOLocation("Location Code") and ItemTracking("Item No.", "Location Code") then
    ...
    var
        ...
        TotalPendingMovQtyExceedsBinAvailErr: Label 'Item tracking defined for line %1, lot number %2, serial number %3, CD number %4 cannot be applied.', Comment = '%1=Line No.,%2=Lot No.,%3=Serial No.,%4=CD No.';
    ...
    begin
        with WhseItemTrackingLine do begin
            ...
            repeat
                ...
                then
                    Error(TotalPendingMovQtyExceedsBinAvailErr, WhseWorksheetLine."Line No.", "Lot No.", "Serial No.","Package No.");
            until Next() = 0;
        end;
    end;
    ...
    procedure ItemTracking(ItemNo: Code[20]; LocationCode: Code[20]): Boolean
    var
        Item: Record Item;
