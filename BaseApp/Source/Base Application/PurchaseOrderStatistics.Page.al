    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("TotalPurchLine[1].""Pmt. Discount Amount"""; TotalPurchLine[1]."Pmt. Discount Amount")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group(Invoicing)
            {
                ...
                field("TotalPurchLine[2].""Pmt. Discount Amount"""; TotalPurchLine[2]."Pmt. Discount Amount")
                {
                    ApplicationArea = Basic, Suite;
                    AutoFormatExpression = "Currency Code";
                    AutoFormatType = 1;
            ...
            group(Shipping)
            {
                ...
                field("TotalPurchLine[3].""Pmt. Discount Amount"""; TotalPurchLine[3]."Pmt. Discount Amount")
                {
                    ApplicationArea = Basic, Suite;
                    AutoFormatExpression = "Currency Code";
                    AutoFormatType = 1;
