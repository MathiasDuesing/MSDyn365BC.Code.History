...
page 403 "Purchase Order Statistics"
{
    ...
    begin
        ...
        if "Prepayment Type" = "Prepayment Type"::Prepayment then begin // NAVCZ
            ...
            // NAVCZ
            PrepmtAmtRequested := TotalPurchLine[1]."Prepmt. Amount Inv. Incl. VAT";
            PurchPostPrepayments.GetPrepmtAmounts(Rec, PrepmtAmtReceived);
        end else
            if "Prepayment Type" = "Prepayment Type"::Advance then begin
                ...
                PrepmtAmtReceived := 0;
                PurchPostAdv.GetPrepmtAmounts(Rec, PrepmtAmtRequested, PrepmtAmtReceived);
