table 5621 "FA Journal Line"
{
    ...
    fields
    {
        ...
        field(12400; "Location Code"; Code[10])
        {
            Caption = 'Location Code';
            TableRelation = "FA Location";
        }
        field(12401; "New Location Code"; Code[10])
        {
            Caption = 'New Location Code';
            TableRelation = "FA Location";
        }
        field(12402; "Reclas. without G/L"; Boolean)
        {
            Caption = 'Reclas. without G/L';
        }
        ...
        field(12410; "Employee No."; Code[20])
        {
            Caption = 'Employee No.';
            TableRelation = Employee;
        }
        field(12411; "New Employee No."; Code[20])
        {
        ...
        field(12450; "Actual Quantity"; Decimal)
        {
        ...
        field(12453; "Calc. Amount"; Decimal)
        {
            Caption = 'Calc. Amount';
            Editable = false;
        }
        field(12454; "Phys. Inventory"; Boolean)
        {
        ...
        field(17302; "Actual  Remaining Amount"; Decimal)
        {
            Caption = 'Actual  Remaining Amount';
        }
        field(17303; "Tax Difference Code"; Code[10])
        {
