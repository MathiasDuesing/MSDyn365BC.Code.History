    ...
    begin
        ...
        case MainRecordRef.Number of
            ...
            DATABASE::"Sales Advance Letter Header":
                begin
                    MainRecordRef.SetTable(SalesAdvanceLetterHeader);
                    IncomingDocumentAttachment.SetRange("Document Table No. Filter", MainRecordRef.Number);
                    IncomingDocumentAttachment.SetRange("Document No. Filter", SalesAdvanceLetterHeader."No.");
                end;
            DATABASE::"Purch. Advance Letter Header":
                begin
                    MainRecordRef.SetTable(PurchAdvanceLetterHeader);
                    IncomingDocumentAttachment.SetRange("Document Table No. Filter", MainRecordRef.Number);
