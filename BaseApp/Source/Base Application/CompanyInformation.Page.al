    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Transmission Intermediary No."; "Transmission Intermediary No.")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group(Administration)
            {
                ...
                field("Register Company No."; "Register Company No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the company''s registration code from the Chamber of Commerce Register subscription.';
                }
                field("Registry Office Province"; "Registry Office Province")
                {
                    ApplicationArea = Basic, Suite;
