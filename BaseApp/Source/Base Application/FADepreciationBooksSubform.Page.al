    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("(""Disposal Date"" > 0D) AND (BookValue = 0)"; ("Disposal Date" > 0D) and (BookValue = 0))
                {
                    ApplicationArea = FixedAssets;
                    Caption = 'Disposed Of';
                    Editable = false;
                ...
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the depreciation bonus associated with the fixed asset depreciation book.';
                }
                field("Depr. Bonus Base Amount"; Rec."Depr. Bonus Base Amount")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the depreciated bonus base amount associated with the fixed asset depreciation book.';
                }
                field("Depr. Bonus %"; Rec."Depr. Bonus %")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the depreciated bonus percentage associated with the fixed asset depreciation book.';
                }
            }
        }
    }
