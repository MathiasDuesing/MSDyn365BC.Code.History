...
report 11786 "Customer - Bal. Reconciliation"
{
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(Customer__Last_Statement_No__; "Last Statement No.")
            {
            }
            ...
            column(Customer__Fax_No__; "Fax No.")
            {
            }
            column(CompanyInfo__Fax_No__; CompanyInfo."Fax No.")
            {
            }
            column(Customer__E_Mail_; "E-Mail")
            {
            }
            ...
            column(Customer_Name_Control1470089; Name)
            {
            }
            column(Customer__Registration_No__; "Registration No.")
            {
            }
            column(CompanyInfo__Registration_No__; CompanyInfo."Registration No.")
            {
            }
            column(Customer__Tax_Registration_No__; "Tax Registration No.")
            {
            }
            ...
            column(Customer__Fax_No__Caption; FieldCaption("Fax No."))
            {
            }
            column(CompanyInfo__Fax_No__Caption; CompanyInfo__Fax_No__CaptionLbl)
            {
            }
            column(Customer__E_Mail_Caption; FieldCaption("E-Mail"))
            {
            }
            ...
            column(Customer__Registration_No__Caption; FieldCaption("Registration No."))
            {
            }
            column(CompanyInfo__Registration_No__Caption; CompanyInfo__Registration_No__CaptionLbl)
            {
            }
            column(Customer__Tax_Registration_No__Caption; FieldCaption("Tax Registration No."))
            {
            }
            ...
            column(ForCompanyConfirms; StrSubstNo(ForCompanyConfirms, Customer.Name))
            {
            }
            ...
            dataitem(Footer; "Integer")
            {
                ...
                column(Customer_Name_Control1470121; Customer.Name)
                {
                }
            ...
            begin
                ...
                CVMgt.FillCVBuffer(CurrencyBuf, CVLedgEntry, "No.", VendorNo, ReconcileDate, PrintAmountsInCurrency);
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(PrintAmountsInCurrency; PrintAmountsInCurrency)
                    {
                        ...
                        ToolTip = 'Specifies to indicate that the report must show customer debt in the original currency.';
                    }
    ...
    var
        ...
        SubjectText: Label 'Subject: Receivables reconcilitation at %1';
        HeaderText1: Label 'In accordance with par. 29 of the Act No. 563/1991 Coll. on Accounting as amended';
        HeaderText2: Label 'We ask you to agree and confirm the status of our receivables on %1';
        ...
        ConfirmationText2: Label 'The debtor acknowledges his obligations on %1 to the creditor as to the reason and amount';
