table 5900 "Service Header"
{
    ...
    fields
    {
        ...
        field(7; "Bill-to Address"; Text[100])
        {
            ...
            begin
                PostCodeCheck.ValidateAddress(
                  CurrFieldNo, DATABASE::"Service Header", GetPosition, 1,
                  "Bill-to Name", "Bill-to Name 2", "Bill-to Contact",
                  "Bill-to Address", "Bill-to Address 2", "Bill-to City", "Bill-to Post Code",
        ...
        field(15; "Ship-to Address"; Text[100])
        {
            ...
            begin
                PostCodeCheck.ValidateAddress(
                  CurrFieldNo, DATABASE::"Service Header", GetPosition, 2,
                  "Ship-to Name", "Ship-to Name 2", "Ship-to Contact",
                  "Ship-to Address", "Ship-to Address 2", "Ship-to City", "Ship-to Post Code",
        ...
        field(81; Address; Text[100])
        {
            ...
            begin
                PostCodeCheck.ValidateAddress(
                  CurrFieldNo, DATABASE::"Service Header", GetPosition, 0,
                  Name, "Name 2", "Contact Name", Address, "Address 2", City, "Post Code", County, "Country/Region Code");
    ...
    begin
        ...
        PostCodeCheck.MoveAllAddressID(
          DATABASE::"Service Header", xRec.GetPosition,
          DATABASE::"Service Header", GetPosition);
    end;
    ...
    begin
        ...
        PostCodeCheck.CopyAddressID(
            DATABASE::"Ship-to Address", ShipToAddr.GetPosition, 0,
    ...
    begin
        ...
        PostCodeCheck.CopyAddressID(
            DATABASE::Customer, SellToCustomer.GetPosition, 0,
            DATABASE::"Service Header", GetPosition, 2);
    ...
    begin
        ...
        PostCodeCheck.CopyAddressID(
          DATABASE::Customer, Cust.GetPosition, 0, DATABASE::"Service Header", GetPosition, 1);
        if not SkipBillToContact then
            "Bill-to Contact" := Cust.Contact;
