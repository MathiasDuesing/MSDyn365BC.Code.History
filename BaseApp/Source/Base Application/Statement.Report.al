                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        dataitem("Detailed Cust. Ledg. Entry"; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            column(IntAmt_DtldCustLedgEntries; IntArrearsAmounttoPay)
                            {
                                AutoFormatExpression = "Currency Code";
                                AutoFormatType = 1;
                            }
                                ...
                                case "Entry Type" of
                                    "Entry Type"::"Initial Entry":
                                        begin
                                            ...
                                            IntArrearsAmounttoPay := CustLedgerEntry."Int. Arrears Amount to Pay";
                                        end;
                    ...
                    dataitem(CustLedgEntry2; "Cust. Ledger Entry")
                    {
                        ...
                        column(IntAmt_CustLedgEntry2; "Int. Arrears Amount to Pay")
                        {
                            AutoFormatExpression = "Currency Code";
                            AutoFormatType = 1;
                            IncludeCaption = true;
