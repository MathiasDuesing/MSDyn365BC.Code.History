report 116 Statement
{
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(EnterpriseNo_CompanyInfo; CompanyInfo."Enterprise No.")
                {
                }
                ...
                column(VATRegNo_CompanyInfoCaption; EnterpriseNo_CompanyInfoCaptionLbl)
                {
                }
    ...
    var
        ...
        EnterpriseNo_CompanyInfoCaptionLbl: Label 'Enterprise No';
