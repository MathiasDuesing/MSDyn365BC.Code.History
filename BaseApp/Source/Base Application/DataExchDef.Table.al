table 1222 "Data Exch. Def"
{
    ...
    fields
    {
        ...
        field(10; "Column Separator"; Option)
        {
            ...
            InitValue = Comma;
            OptionCaption = ',Tab,Semicolon,Comma,Space,Equal,Custom';
            OptionMembers = ,Tab,Semicolon,Comma,Space,Equal,Custom;
        }
        ...
        field(12401; "Document Start Tag"; Text[250])
        {
            Caption = 'Document Start Tag';
        }
        field(12402; "Document End Tag"; Text[250])
        {
            Caption = 'Document End Tag';
        }
    }
