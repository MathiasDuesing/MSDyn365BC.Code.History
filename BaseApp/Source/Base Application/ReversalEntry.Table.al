table 179 "Reversal Entry"
{
    ...
    begin
        if RevType = RevType::Transaction then begin
            ...
            WHTEntry.SetCurrentKey("Transaction No.");
    ...
    begin
        case "Entry Type" of
            ...
            "Entry Type"::WHT:
                exit(StrSubstNo('%1', WHTEntry.TableCaption()));
            else begin
    ...
    protected procedure InsertFromWHTEntry(var TempRevertTransactionNo: Record "Integer" temporary; Number: Integer; RevType: Option Transaction,Register; var NextLineNo: Integer)
    begin
        TempRevertTransactionNo.FindSet();
        repeat
            if RevType = RevType::Transaction then
