table 179 "Reversal Entry"
{
    ...
    begin
        ...
        CheckPostingDate(
          ...
          CustLedgEntry."Entry No.", CustLedgEntry."Journal Templ. Name");
    ...
    begin
        ...
        CheckPostingDate(
          ...
          VendLedgEntry."Journal Templ. Name");
    ...
    begin
        ...
        CheckPostingDate(
          ...
          EmployeeLedgerEntry."Journal Templ. Name");
    ...
    begin
        ...
        CheckPostingDate(
          ...
          BankAccLedgEntry."Journal Templ. Name");
