table 179 "Reversal Entry"
{
    ...
    begin
        ...
        CheckPostingDate(
          CustLedgEntry."Posting Date", CustLedgEntry.TableCaption,
          CustLedgEntry."Entry No.", CustLedgEntry."Journal Template Name");
    ...
    begin
        ...
        CheckPostingDate(
          ...
          VendLedgEntry."Journal Template Name");
    ...
    local procedure CheckEmpl(EmployeeLedgerEntry: Record "Employee Ledger Entry")
    var
    ...
    begin
        ...
        CheckPostingDate(
          ...
          EmployeeLedgerEntry."Journal Template Name");
    ...
    begin
        ...
        CheckPostingDate(
          ...
          BankAccLedgEntry."Journal Template Name");
    ...
    begin
        ...
        CheckPostingDate(VATEntry."Posting Date", VATEntry.TableCaption, VATEntry."Entry No.",
          VATEntry."Journal Template Name");
    ...
    local procedure CheckDtldEmplLedgEntry(EmployeeLedgerEntry: Record "Employee Ledger Entry")
    var
        DetailedEmployeeLedgerEntry: Record "Detailed Employee Ledger Entry";
    begin
    ...
    begin
        ...
        SourceCodeSetup.Get();
        if (GLReg."Journal Batch Name" = '') or
           (GLReg."Source Code" in [SourceCodeSetup."Sales Entry Application", SourceCodeSetup."Purchase Entry Application"])
        then
    ...
    begin
        IsHandled := false;
        OnBeforeCheckPostingDate(PostingDate, Caption, EntryNo, JnlTemplName, IsHandled, Rec);
        if IsHandled then
            exit;
    ...
    begin
        ...
        repeat
            ...
            if GLEntry.FindSet then
                repeat
                    if GLEntry."Remaining Amount" <> GLEntry.Amount then begin
                        if GLEntry.Open then
                            Error(Text000, GLEntry.TableCaption, GLEntry."Entry No.");
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckPostingDate(PostingDate: Date; Caption: Text[50]; EntryNo: Integer; JnlTemplName: Code[10]; var IsHandled: Boolean; var ReversalEntry: Record "Reversal Entry")
    begin
    end;
