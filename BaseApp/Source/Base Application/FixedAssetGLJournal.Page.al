    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies if the general journal line has a depreciation bonus.';
                }
                field("Tax Difference Code"; "Tax Difference Code")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the tax difference code associated with the general journal line.';
                }
