table 21 "Cust. Ledger Entry"
{
    ...
    keys
    {
        ...
        key(Key17; "Source Code", "Posting Date", "Document No.")
        {
        }
        key(Key18; "Customer No.", "Applies-to ID", Open, Positive, "Due Date")
        {
        }
        key(Key19; "Source Code", "Document No.", "Posting Date")
        {
        }
        key(Key20; "Customer No.", "Posting Date", "Source Code")
        {
        }
        key(Key21; "Customer No.", "Document No.", "Posting Date")
        {
        }
        key(Key22; "Applies-to ID")
        {
        }
