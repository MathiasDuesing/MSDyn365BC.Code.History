table 21 "Cust. Ledger Entry"
{
    ...
    keys
    {
        ...
        key(Key4; "Document No.", "Document Type", "Customer No.")
        {
        }
        ...
        key(Key13; "Customer No.", "Global Dimension 1 Code", "Global Dimension 2 Code", "Posting Date", "Currency Code", "Agreement No.")
        {
            Enabled = false;
            SumIndexFields = "Sales (LCY)", "Profit (LCY)", "Inv. Discount (LCY)";
        }
