codeunit 6501 "Item Tracking Data Collection"
{
        ...
        case LookupMode of
            LookupMode::"Serial No.":
                begin
                    ...
                    if TempTrackingSpecification."CD No." <> '' then
                        TempGlobalEntrySummary.SetRange("CD No.", TempTrackingSpecification."CD No.");
            ...
            LookupMode::"Lot No.":
                begin
                    ...
                    TempGlobalEntrySummary.SetRange("Lot/CD Exists", true);
            ...
            LookupMode::"CD No.":
                begin
                    ...
                    if TempGlobalEntrySummary.FindFirst then
                        ItemTrackingSummaryForm.SetRecord(TempGlobalEntrySummary);
                    TempGlobalEntrySummary.SetRange("CD No.");
                    TempGlobalEntrySummary.SetRange("Lot/CD Exists", true);
                    ItemTrackingSummaryForm.Caption := StrSubstNo(Text009, TempGlobalEntrySummary.FieldCaption("CD No."));
                end;
        end;
        ...
        case LookupMode of
            ...
            LookupMode::"CD No.":
                begin
                    TempGlobalEntrySummary.SetRange("Serial No.", '');
                    TempGlobalEntrySummary.SetRange("CD No.", TempTrackingSpecification."CD No.");
                    TempGlobalReservEntry.SetRange("CD No.", TempTrackingSpecification."CD No.");
                    ItemTrackingSummaryForm.Caption := StrSubstNo(
                        Text010, TempTrackingSpecification.FieldCaption("CD No."), TempTrackingSpecification."CD No.");
                end;
        end;
    ...
    begin
        ...
        case LookupMode of
            ...
            LookupMode::"Lot No.":
                begin
                    if (TempReservEntry."Lot No." = '') and (TempReservEntry."CD No." = '') then
                        exit;

                    TempGlobalEntrySummary.SetTrackingFilter('', TempReservEntry."Lot No.", TempReservEntry."CD No.");
                    if TempReservEntry."Serial No." <> '' then
        ...
        if not TempGlobalEntrySummary.FindFirst then begin
            ...
            TempGlobalEntrySummary."CD No." := TempReservEntry."CD No.";
            TempGlobalEntrySummary."Lot/CD Exists" :=
              (TempGlobalEntrySummary."Lot No." <> '') or (TempGlobalEntrySummary."CD No." <> '');
        ...
        case LookupMode of
            ...
            LookupMode::"Lot No.":
                if (TempTrackingSpecification."Lot No." = '') or (not CurrItemTrackingCode."Lot Specific Tracking") then
                    exit(true);
            LookupMode::"CD No.":
                if (TempTrackingSpecification."CD No." = '') or (not CurrItemTrackingCode."CD Specific Tracking") then
                    exit(true);
        end;
    ...
    begin
        ...
        TempGlobalChangedEntrySummary.Reset();
        TempGlobalChangedEntrySummary.SetCurrentKey("Lot No.", "Serial No.", "CD No.");
        ...
        if not TempGlobalChangedEntrySummary.FindFirst then begin
            ...
            TempGlobalChangedEntrySummary."Lot/CD Exists" :=
              (TempGlobalEntrySummary."Lot No." <> '') or (TempGlobalEntrySummary."CD No." <> '');
    ...
    begin
        ...
        if TempGlobalChangedEntrySummary.FindSet then
            repeat
                if (TempGlobalChangedEntrySummary."Lot No." <> '') and (TempGlobalChangedEntrySummary."CD No." <> '') then begin
                    // only last record with Lot Number updates Summary
                    if (TempGlobalChangedEntrySummary."Lot No." <> TempLastGlobalEntrySummary."Lot No.") or
                       (TempGlobalChangedEntrySummary."CD No." <> TempLastGlobalEntrySummary."CD No.")
                    then
    ...
    begin
        ...
        if ChangedEntrySummary."Serial No." <> '' then begin
            ...
            if (ChangedEntrySummary."Lot No." <> '') or (ChangedEntrySummary."CD No." <> '') and not SkipLot then begin
                TempGlobalEntrySummary.SetFilter("Serial No.", '<>%1', '');
                TempGlobalEntrySummary.SetRange("Lot No.", ChangedEntrySummary."Lot No.");
                TempGlobalEntrySummary.SetRange("CD No.", ChangedEntrySummary."CD No.");
        ...
        if (ChangedEntrySummary."Lot No." <> '') or (ChangedEntrySummary."CD No." <> '') and not SkipLot then begin
            TempGlobalEntrySummary.SetRange("Serial No.", '');
            if ChangedEntrySummary."Lot No." <> '' then
                TempGlobalEntrySummary.SetRange("Lot No.", ChangedEntrySummary."Lot No.");
            if ChangedEntrySummary."CD No." <> '' then
                TempGlobalEntrySummary.SetRange("CD No.", ChangedEntrySummary."CD No.");
    ...
    begin
        ...
        if CurrItemTrackingCode."CD Warehouse Tracking" then
            if TempEntrySummary."CD No." <> '' then
                WarehouseEntry.SetRange("CD No.", TempEntrySummary."CD No.");
    ...
    begin
        ...
        GlobalChangedEntrySummary.SetRange("CD No.", GlobalChangedEntrySummary."CD No.");
