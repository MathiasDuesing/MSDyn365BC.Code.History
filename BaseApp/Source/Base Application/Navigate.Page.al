page 344 Navigate
{
    ...
    begin
        if CarteraDoc.ReadPermission() then begin
            ...
            InsertIntoDocEntry(Rec, DATABASE::"Cartera Doc.", CarteraDoc.TableCaption, CarteraDoc.Count);
        end;
        if PostedCarteraDoc.ReadPermission() then begin
            ...
            InsertIntoDocEntry(Rec, DATABASE::"Posted Cartera Doc.", PostedCarteraDoc.TableCaption, PostedCarteraDoc.Count);
        end;
        if ClosedCarteraDoc.ReadPermission() then begin
            ...
            InsertIntoDocEntry(Rec, DATABASE::"Closed Cartera Doc.", ClosedCarteraDoc.TableCaption, ClosedCarteraDoc.Count);
        end;
    end;
