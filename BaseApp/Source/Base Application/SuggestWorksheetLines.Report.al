report 840 "Suggest Worksheet Lines"
{
    ...
    begin
        with CFWorksheetLine2 do begin
            ...
            "VAT Base Amount" := CalcVATBaseAmtForCustLedgEntry("Cust. Ledger Entry");
    ...
    begin
        with CFWorksheetLine2 do begin
            ...
            "VAT Base Amount" := CalcVATBaseAmtForVendLedgEntry("Vendor Ledger Entry");
    ...
    begin
        ...
        then begin
            ...
            with CFWorksheetLine2 do begin
                ...
                "VAT Base Amount" := CalculateVATBaseAmtForPurchLine(PurchHeader, "Purchase Line");
    ...
    begin
        ...
        then begin
            ...
            with CFWorksheetLine2 do begin
                ...
                "VAT Base Amount" := CalculateVATBaseAmtForServiceLine(ServiceHeader, "Service Line");
    ...
    begin
        with CustLedgEntry do
            exit(-CalcVATBaseAmtFromVATEntry("Posting Date", "Document No.", VATEntry.Type::Sale));
    end;
    ...
    begin
        with VendLedgEntry do
            exit(-CalcVATBaseAmtFromVATEntry("Posting Date", "Document No.", VATEntry.Type::Purchase));
    end;

    local procedure CalcVATBaseAmtFromVATEntry(PostingDate: Date; DocNo: Code[20]; EntryType: Option) VATBaseAmount: Decimal
    var
        VATEntry: Record "VAT Entry";
    begin
