report 840 "Suggest Worksheet Lines"
{
    ...
    requestpage
    {
        ...
        begin
            ...
            if ConsiderSource[SourceType::"Sales Advance Letters".AsInteger()] then
                ConsiderSource[SourceType::"Sales Advance Letters".AsInteger()] := "Sales Advance Letter Line".ReadPermission;
            if ConsiderSource[SourceType::"Purchase Advance Letters".AsInteger()] then
                ConsiderSource[SourceType::"Purchase Advance Letters".AsInteger()] := "Purch. Advance Letter Line".ReadPermission;
        end;
    }
