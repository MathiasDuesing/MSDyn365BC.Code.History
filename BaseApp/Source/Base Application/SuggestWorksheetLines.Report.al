report 840 "Suggest Worksheet Lines"
{
    ...
    dataset
    {
        dataitem("Cash Flow Forecast"; "Cash Flow Forecast")
        {
            ...
            dataitem("Sales Advance Letter Line"; "Sales Advance Letter Line")
            {
                ...
                trigger OnPreDataItem()
                begin
                    if not ConsiderSource[SourceType::"Sales Advance Letters"] then
                        CurrReport.Break();
            ...
            dataitem("Purch. Advance Letter Line"; "Purch. Advance Letter Line")
            {
                ...
                trigger OnPreDataItem()
                begin
                    if not ConsiderSource[SourceType::"Purchase Advance Letters"] then
                        CurrReport.Break();
    ...
    requestpage
    {
        ...
        begin
            ...
            if ConsiderSource[SourceType::"Sales Advance Letters"] then
                ConsiderSource[SourceType::"Sales Advance Letters"] := "Sales Advance Letter Line".ReadPermission;
            if ConsiderSource[SourceType::"Purchase Advance Letters"] then
                ConsiderSource[SourceType::"Purchase Advance Letters"] := "Purch. Advance Letter Line".ReadPermission;
    ...
    var
        ...
        SourceType: Option ,Receivables,Payables,"Liquid Funds","Cash Flow Manual Expense","Cash Flow Manual Revenue","Sales Order","Purchase Order","Budgeted Fixed Asset","Sale of Fixed Asset","Service Orders","G/L Budget","Sales Advance Letters","Purchase Advance Letters",Job,Tax,"Azure AI";
        CashFlowNo: Code[20];
        LineNo: Integer;
