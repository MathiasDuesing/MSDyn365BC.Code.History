codeunit 364 "PostPurch-Delete"
{
    ...
    var
        ...
        NotAllowedToDeletePostedDocsErr: Label 'You are not allowed to delete posted documents.';
    ...
    begin
        PurchSetup.Get();
        if PurchSetup."Prevent Posted Doc. Deletion" then
            Error(NotAllowedToDeletePostedDocsErr);
