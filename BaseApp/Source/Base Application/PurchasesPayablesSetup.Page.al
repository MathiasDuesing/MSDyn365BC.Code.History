    ...
    layout
    {
        area(content)
        {
            ...
            group("Number Series")
            {
...
#if not CLEAN20
                field("Journal Templ. Purch. Invoice"; Rec."Journal Templ. Purch. Invoice")
                {
...
#if not CLEAN20
                field("Journal Templ. Purch. Cr. Memo"; Rec."Journal Templ. Purch. Cr. Memo")
                {
                    ApplicationArea = BasicBE;
...
#if not CLEAN20
                field("Jnl. Templ. Prep. P. Inv."; Rec."Jnl. Templ. Prep. P. Inv.")
                {
                    ApplicationArea = BasicBE;
                    ObsoleteReason = 'Replaced by W1 field P. Prep. Inv. Template Name';
                    ObsoleteState = Pending;
                    ObsoleteTag = '20.0';
                    ToolTip = 'Specifies which general journal template to use for purchase invoices.';
                    Visible = false;
                }
                field("Jnl. Templ. Prep. P. Cr. Memo"; Rec."Jnl. Templ. Prep. P. Cr. Memo")
                {
                    ApplicationArea = BasicBE;
                ...
                field("IC Jnl. Templ. Purch. Invoice"; Rec."IC Jnl. Templ. Purch. Invoice")
                {
                    ApplicationArea = BasicBE;
                ...
                field("IC Jnl. Templ. Purch. Cr. Memo"; Rec."IC Jnl. Templ. Purch. Cr. Memo")
                {
                    ApplicationArea = BasicBE;
