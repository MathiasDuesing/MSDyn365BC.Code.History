    ...
    layout
    {
        area(content)
        {
            ...
            group("WHT/GST")
            {
                ...
                field("Print WHT Docs. on Pay. Post"; "Print WHT Docs. on Pay. Post")
                {
                    ApplicationArea = Basic, Suite;
