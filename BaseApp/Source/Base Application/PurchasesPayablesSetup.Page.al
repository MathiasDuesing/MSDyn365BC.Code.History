    ...
    layout
    {
        area(content)
        {
            ...
            group("Number Series")
            {
                ...
                field("Journal Templ. Purch. Invoice"; "Journal Templ. Purch. Invoice")
                {
                ...
                field("Journal Templ. Purch. Cr. Memo"; "Journal Templ. Purch. Cr. Memo")
                {
                    ApplicationArea = BasicBE;
                ...
                field("Jnl. Templ. Prep. P. Inv."; "Jnl. Templ. Prep. P. Inv.")
                {
                    ApplicationArea = BasicBE;
                    ToolTip = 'Specifies which general journal template to use for purchase invoices.';
                }
                field("Jnl. Templ. Prep. P. Cr. Memo"; "Jnl. Templ. Prep. P. Cr. Memo")
                {
                    ApplicationArea = BasicBE;
                    ToolTip = 'Specifies which general journal template to use for purchase invoices.';
                }
                field("IC Jnl. Templ. Purch. Invoice"; "IC Jnl. Templ. Purch. Invoice")
                {
                    ApplicationArea = BasicBE;
                    ToolTip = 'Specifies the intercompany journal template to use for purchase invoices.';
                }
                field("IC Jnl. Templ. Purch. Cr. Memo"; "IC Jnl. Templ. Purch. Cr. Memo")
                {
                    ApplicationArea = BasicBE;
