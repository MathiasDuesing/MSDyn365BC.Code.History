report 11000010 "Export BTL91-RABO"
{
        ...
        dataitem("Payment History"; "Payment History")
        {
            ...
            dataitem("Payment History Line"; "Payment History Line")
            {
                ...
                begin
                    ...
                    CostDomestic := 1;
                    if "Transfer Cost Domestic" = "Transfer Cost Domestic"::Principal then begin
            ...
            begin
                ...
                if "Acc. Hold. Country/Region Code" <> '' then
                    ...
                    Clear(Country);
                HeaderInfo("Account Holder Name", "Account Holder Address",
                  "Account Holder City",
                  Country.Name, "Exchange bank");
    ...
    var
        Text1000002: Label 'BTL91 data has been exported to disk.\';
        Text1000003: Label 'File names can be found on payment history form';
        Text1000004: Label 'No BTL91 data has been exported to disk.\';
    ...
    [Scope('OnPrem')]
    procedure HeaderInfo(AcctHolder: Text[100]; Address: Text[100]; City: Text[50]; "Country Code": Code[50]; "Exchange bank": Text[30])
    begin
    ...
    [Scope('OnPrem')]
    procedure Paymentrecord2Info(AccNrBeneficiary: Text[50]; NameBeneficiary: Text[100]; AddressBeneficiary: Text[100]; CityBeneficiary: Text[30]; Landcodebeneficiary: Code[10]; Orderno: Integer; "Country Name": Text[30])
    begin
