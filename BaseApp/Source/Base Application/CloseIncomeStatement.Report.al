report 94 "Close Income Statement"
{
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            trigger OnPreDataItem()
            begin
                if BalancingAccount."No." <> '' then
                    SetFilter("No.", '<>%1', BalancingAccount."No.");
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(BalancingAccountNo; BalancingAccount."No.")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Balancing Account No.';
                        TableRelation = "G/L Account";
                        ToolTip = 'Specifies the balancing account.';
                    }
                    ...
                    field(NetProfitAccountNo; NetProfitAccount."No.")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Net Profit Account No.';
                        TableRelation = "G/L Account";
                        ToolTip = 'Specifies the account for net profit.';
                    }
                    field(NetLossAccountNo; NetLossAccount."No.")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Net Loss Account No.';
                        TableRelation = "G/L Account";
                        ToolTip = 'Specifies the account for net loss.';
                    }
    ...
    var
        ...
        BalancingAccount: Record "G/L Account";
        NetProfitAccount: Record "G/L Account";
        NetLossAccount: Record "G/L Account";
