page 303 "Vendor Entry Statistics"
{
            ...
            group("Last Documents")
            {
                ...
                fixed(Control1903895301)
                {
                    ...
                    group(Date)
                    {
                        ...
                        field("VendLedgEntry[7].""Posting Date"""; VendLedgEntry[7]."Posting Date")
                        {
                    ...
                    group("Document No.")
                    {
                        ...
                        field("VendLedgEntry[7].""Document No."""; VendLedgEntry[7]."Document No.")
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Document No.';
                    ...
                    group("Currency Code")
                    {
                        ...
                        field("VendLedgEntry[7].""Currency Code"""; VendLedgEntry[7]."Currency Code")
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Currency Code';
                            ToolTip = 'Specifies the code for the currency that amounts are shown in.';
                    ...
                    group(Control1900724301)
                    {
                        ...
                        field("VendLedgEntry[7].Amount"; VendLedgEntry[7].Amount)
                        {
                            ApplicationArea = Basic, Suite;
                            AutoFormatExpression = VendLedgEntry[7]."Currency Code";
                            AutoFormatType = 1;
                            Caption = 'Amount';
                    ...
                    group("Remaining Amount")
                    {
                        ...
                        field("VendLedgEntry[7].""Remaining Amount"""; VendLedgEntry[7]."Remaining Amount")
                        {
                            ApplicationArea = Basic, Suite;
                            AutoFormatExpression = VendLedgEntry[7]."Currency Code";
                            AutoFormatType = 1;
    ...
    var
        VendLedgEntry: array[7] of Record "Vendor Ledger Entry";
