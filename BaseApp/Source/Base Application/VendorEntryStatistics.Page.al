page 303 "Vendor Entry Statistics"
{
            ...
            group("Last Documents")
            {
                ...
                fixed(Control1903895301)
                {
                    ...
                    group(Date)
                    {
                        ...
                        field("VendLedgEntry[21].""Posting Date"""; VendLedgEntry[21]."Posting Date")
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Bill';
                            ToolTip = 'Specifies statistics for bills.';
                        }
                    ...
                    group("Document No.")
                    {
                        ...
                        field("VendLedgEntry[21].""Document No."""; VendLedgEntry[21]."Document No.")
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Document No.';
                    ...
                    group("Currency Code")
                    {
                        ...
                        field("VendLedgEntry[21].""Currency Code"""; VendLedgEntry[21]."Currency Code")
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Currency Code';
                    ...
                    group(Control1900724301)
                    {
                        ...
                        field("-VendLedgEntry[21].Amount"; -VendLedgEntry[21].Amount)
                        {
                            ApplicationArea = Basic, Suite;
                            AutoFormatExpression = VendLedgEntry[21]."Currency Code";
                            AutoFormatType = 1;
                            Caption = 'Amount';
                    ...
                    group("Remaining Amount")
                    {
                        ...
                        field("-VendLedgEntry[21].""Remaining Amount"""; -VendLedgEntry[21]."Remaining Amount")
                        {
                            ApplicationArea = Basic, Suite;
                            AutoFormatExpression = VendLedgEntry[21]."Currency Code";
                            AutoFormatType = 1;
    ...
    var
        VendLedgEntry: array[21] of Record "Vendor Ledger Entry";
