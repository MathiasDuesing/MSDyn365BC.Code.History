    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
            {
                ...
                DataItemTableView = SORTING("Vendor No.", "Posting Date", "Currency Code") where("Document Status" = filter(<> Redrawn));
                PrintOnlyIfDetail = true;
            ...
            {
                DataItemLink = "Vendor No." = FIELD("No.");
                DataItemTableView = SORTING("Vendor No.", Open, Positive, "Due Date", "Currency Code") where ("Document Status"=filter(<>Redrawn));
                PrintOnlyIfDetail = true;
