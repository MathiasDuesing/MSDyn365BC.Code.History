report 412 "Purchase Prepmt. Doc. - Test"
{
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem(VATCounter; "Integer")
                {
                    ...
                    column(VATAmountLine__EC_Amount__Control1100007Caption; VATAmountLine__EC_Amount__Control1100007CaptionLbl)
                    {
                    }
    ...
    var
        ...
        Text019: Label 'Prepayment Document Type';
        ...
        VATAmountLine__EC_Amount__Control1100007CaptionLbl: Label 'EC Amount';
