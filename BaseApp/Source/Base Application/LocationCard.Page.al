        ...
        area(content)
        {
            ...
            group("Address & Contact")
            {
                ...
                group(ContactDetails)
                {
                    ...
                    {
                        ApplicationArea = Location;
                        ToolTip = 'Specifies the responsible employee number associated with the salesperson or purchaser.';
                    }
                    field("Last Goods Report No."; Rec."Last Goods Report No.")
                    {
                        ApplicationArea = Location;
                        ToolTip = 'Specifies the number of times that the Item Report TORG-29 report has been created.';
                    }
                    field("Last Goods Report Date"; Rec."Last Goods Report Date")
                    {
                        ApplicationArea = Location;
                        ToolTip = 'Specifies the date that the Item Report TORG-29 report was last created.';
                    }
