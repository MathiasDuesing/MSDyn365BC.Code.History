table 27 Item
{
    ...
    [Obsolete('Not needed anymore after conversion to Enum.', '17.0')]
    procedure GetReplenishmentSystemForSKU(): Integer
    var
        StockkeepingUnit: Record "Stockkeeping Unit";
    begin
        case "Replenishment System" of
            "Replenishment System"::Purchase:
                exit(StockkeepingUnit."Replenishment System"::Purchase.AsInteger());
            "Replenishment System"::"Prod. Order":
                exit(StockkeepingUnit."Replenishment System"::"Prod. Order".AsInteger());
            "Replenishment System"::" ":
                exit(StockkeepingUnit."Replenishment System"::" ".AsInteger());
            "Replenishment System"::Assembly:
                exit(StockkeepingUnit."Replenishment System"::Assembly.AsInteger());
        end;
    end;
