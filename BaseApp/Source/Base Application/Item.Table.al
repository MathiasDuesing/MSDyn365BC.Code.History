table 27 Item
{
    ...
    begin
        case "Replenishment System" of
            "Replenishment System"::Purchase:
                exit(StockkeepingUnit."Replenishment System"::Purchase);
            "Replenishment System"::"Prod. Order":
                exit(StockkeepingUnit."Replenishment System"::"Prod. Order");
            "Replenishment System"::" ":
                exit(StockkeepingUnit."Replenishment System"::" ");
            "Replenishment System"::Assembly:
                exit(StockkeepingUnit."Replenishment System"::Assembly);
        end;
    end;
