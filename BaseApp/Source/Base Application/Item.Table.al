table 27 Item
{
    ...
    fields
    {
        ...
        field(3; Description; Text[100])
        {
            ...
            begin
                ...
                if "Created From Nonstock Item" then begin
                    ...
                    if NonstockItem."Full Description" = '' then begin
                        NonstockItem."Full Description" := "Full Description";
                        ToModify := true;
                    end;
                    if ToModify then
                        // NAVCZ
        ...
        field(11; "Inventory Posting Group"; Code[20])
        {
            ...
            begin
                ...
                CheckOpenItemLedgerEntries; // NAVCZ
            end;
        }
    ...
    var
        ...
        ItemPackageMaterial: Record "Item Package Material";
    begin
        ...
        if not PlanningComponent.IsEmpty then
            Error(PlanningCompErr, TableCaption, "No.");
        // NAVCZ
        ...
        ItemPackageMaterial.SetRange("Item No.", "No."); // NAVCZ
        ItemPackageMaterial.DeleteAll(); // NAVCZ
    end;
    ...
    var
        ...
        PlanningCompErr: Label 'You cannot delete %1 %2 because there is at least one Planning Component that includes this item.';
    ...
    local procedure CheckOpenItemLedgerEntries()
    var
    ...
    begin
        ...
        if not ItemLedgerEntry.IsEmpty then
            FieldError("Inventory Posting Group", ErrorMessage);

        ItemLedgerEntry.SetRange(Open);
        if ItemLedgerEntry.Find('-') then
            repeat
                if ItemLedgerEntry.Quantity <> ItemLedgerEntry."Invoiced Quantity" then
                    FieldError("Inventory Posting Group", ErrorMessage);
