    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("VAT Allocation Type"; Rec."VAT Allocation Type")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the VAT allocation type associated with the VAT entry.';
                }
                field(Base; Base)
                {
                    ApplicationArea = Basic, Suite;
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the VAT entry contains a manual VAT settlement.';
                }
                field("Amount To Allocate"; Rec."Amount To Allocate")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the amount to allocate in the VAT entry.';
                }
                field("Object Type"; Rec."Object Type")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the object type associated with the VAT entry.';
                }
                field("Object No."; Rec."Object No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the object number associated with the VAT entry.';
                }
    ...
    actions
    {
        area(processing)
        {
            group("F&unctions")
            {
                Caption = 'F&unctions';
                Image = "Action";
                action("Reverse Manual Transaction")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Reverse Manual Transaction';
                    Ellipsis = true;
                    Image = ReverseRegister;
                    ToolTip = 'Reverse the selected manual VAT settlement.';
