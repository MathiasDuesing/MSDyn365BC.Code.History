codeunit 1752 "Data Class. Eval. Data Country"
{
    ...
    begin
        ...
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Payment Step Ledger");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Payment Post. Buffer");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Payment Header");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Payment Line");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Payment Header Archive");
