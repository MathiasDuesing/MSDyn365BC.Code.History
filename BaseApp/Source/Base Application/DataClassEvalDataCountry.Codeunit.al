codeunit 1752 "Data Class. Eval. Data Country"
{
    ...
    begin
        ...
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"VAT VIES Correction");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Manual VAT Correction");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Electronic Banking Setup");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::Representative);
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Payment Journal Template");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Payment Journal Line");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Paym. Journal Batch");
        ...
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"CODA Statement");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"CODA Statement Line");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"CODA Statement Source Line");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Transaction Coding");
