codeunit 147330 "Edit Posted Documents ES"
{
    ...
    [ModalPageHandler]
    [Scope('OnPrem')]
    procedure PostedSalesCrMemoUpdateCorrInvNoOKModalPageHandler(var PostedSalesCrMemoUpdate: TestPage "Posted Sales Cr. Memo - Update")
    begin
        PostedSalesCrMemoUpdate."Corrected Invoice No.".SetValue(LibraryVariableStorage.DequeueText());
        PostedSalesCrMemoUpdate.OK().Invoke();
    end;
    ...
    [ModalPageHandler]
    [Scope('OnPrem')]
    procedure PostedSalesCrMemoUpdateCorrInvNoCancelModalPageHandler(var PostedSalesCrMemoUpdate: TestPage "Posted Sales Cr. Memo - Update")
    begin
        PostedSalesCrMemoUpdate."Corrected Invoice No.".SetValue(LibraryVariableStorage.DequeueText());
        PostedSalesCrMemoUpdate.Cancel().Invoke();
    end;
    ...
    [ModalPageHandler]
    [Scope('OnPrem')]
    procedure PostedSalesCrMemoUpdateLookupCorrInvNolModalPageHandler(var PostedSalesCrMemoUpdate: TestPage "Posted Sales Cr. Memo - Update")
    begin
        PostedSalesCrMemoUpdate."Corrected Invoice No.".Lookup();
        PostedSalesCrMemoUpdate."Corrected Invoice No.".AssertEquals(LibraryVariableStorage.DequeueText);
        PostedSalesCrMemoUpdate.Cancel.Invoke();
    end;
