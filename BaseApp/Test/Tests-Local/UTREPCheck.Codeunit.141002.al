codeunit 141002 "UT REP Check"
{
    ...
    begin
        ...
        CreateGenJournalLine(GenJournalLine, LibraryRandom.RandIntInRange(0, 5), '', '');  // // Account Type - option Range 0 to 5 and blank value for Account number and Balance Account number.
    ...
    local procedure OnAfterGetRecordGenJnlLineApplyMethodMoreLinesType(ReportID: Integer; AccountType: Option; AppliesToDocumentNo: Code[20])
    var
        GenJournalLine: Record "Gen. Journal Line";
        BankAccount: Record "Bank Account";
        CheckLedgerEntry: Record "Check Ledger Entry";
    ...
    begin
        ...
        with GenJournalLine do begin
            CreateComputerCheckPmtLine(
              GenJournalLine, Vendor."No.", LibraryRandom.RandIntInRange(10, 100), "Document Type"::"Credit Memo",
              "Account Type"::Vendor, BankAccount."Currency Code");
            CreateGenJournalLine(GenJournalLine, "Account Type"::Vendor, Vendor."No.", BankAccount."No.");
        end;
    ...
    local procedure CreateGenJournalLine(var GenJournalLine: Record "Gen. Journal Line"; AccountType: Option; AccountNo: Code[20]; BalAccountNo: Code[20])
    var
        GenJournalBatch: Record "Gen. Journal Batch";
    begin
    ...
    local procedure CreateComputerCheckPmtLine(var GenJournalLine: Record "Gen. Journal Line"; AccountNo: Code[20]; Amount: Decimal; DocumentType: Option; AccountType: Option; CurrencyCode: Code[10])
    var
        BankAccount: Record "Bank Account";
    begin
        LibraryERM.CreateBankAccount(BankAccount);
        ...
        with GenJournalLine do begin
            ...
            Validate("Check Exported", true);
            Validate("Check Transmitted", true);
            Validate("Currency Code", CurrencyCode);
