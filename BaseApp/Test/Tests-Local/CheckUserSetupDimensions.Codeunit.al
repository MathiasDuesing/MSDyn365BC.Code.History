...
codeunit 145020 "Check User Setup Dimensions"
{
    ...
    var
        ...
        MustEnterDimErr: Label 'You must enter dimension %1.';
        NothingToPostErr: Label 'There is nothing to post.';
        DimCodeMustBeErr: Label 'Dimension Value Code %1 must match the filter %2.';

    [Test]
    [HandlerFunctions('SelectedDimModalPageHandler,EditDimensionSetEntriesModalPageHandler')]
    [Scope('OnPrem')]
    procedure T100_SalesHeaderWithMissedSelectedDimensionValue()
    var
    ...
    begin
        ...
        ErrorMessagesPage."Field Name".AssertEquals(UserSetup.FieldCaption("Check Dimension Values"));
    ...
    [HandlerFunctions('SelectedDimModalPageHandler,EditDimensionSetEntriesModalPageHandler')]
    [Scope('OnPrem')]
    procedure T200_PurchHeaderWithMissedSelectedDimensionValue()
    var
    ...
    begin
        ...
        VerifyHeaderDimError(PurchHeader.RecordId, UserSetup.RecordId, ExpectedErrorMessage);
        LibraryErrorMessage.GetTestPage(ErrorMessagesPage);
        ErrorMessagesPage.First;
        ErrorMessagesPage."Field Name".AssertEquals(UserSetup.FieldCaption("Check Dimension Values"));
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(CODEUNIT::"Check User Setup Dimensions");
    ...
    begin
        ...
        GeneralLedgerSetup."User Checks Allowed" := true;
        GeneralLedgerSetup.Modify();

        UserSetup.Get(UserId);
        UserSetup."Check Dimension Values" := true;
        UserSetup.Modify();
    end;
