codeunit 144019 "ERM Accrual Accounting"
{
    ...
    var
        ...
        LibrarySELocalization: Codeunit "Library - SE Localization";
    ...
    begin
        ...
        LibrarySELocalization.CreateAutomaticAccountHeader(AutomaticAccHeader);
    ...
    begin
        LibrarySELocalization.CreateAutomaticAccountLine(AutomaticAccLine, AutomaticAccNo);
