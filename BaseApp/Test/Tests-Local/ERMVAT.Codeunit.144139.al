codeunit 144139 "ERM VAT"
{
    ...
    begin
        ...
        FindVATEntries(PurchaseVATEntry, VATPostingSetup, PostedDocNo, PurchaseVATEntry[1].Type::Purchase);
        ...
        FindVATEntries(SaleVATEntry, VATPostingSetup, PostedDocNo, SaleVATEntry[1].Type::Sale);
    ...
    begin
        for i := 1 to ArrayLen(VATEntry) do begin
            ...
            VATEntry[i].SetRange(Type, VATEntryType);
