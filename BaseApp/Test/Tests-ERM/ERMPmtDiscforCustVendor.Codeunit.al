codeunit 134088 "ERM Pmt Disc for Cust/Vendor"
{
    ...
    begin
        ...
        SetAdjustForPaymentDiscountOnGeneralLedgerSetup(true);
    ...
    local procedure SetAdjustForPaymentDiscountOnGeneralLedgerSetup(NewAdjustValue: Boolean);
    var
      GeneralLedgerSetup: Record "General Ledger Setup";
    begin
      GeneralLedgerSetup.Get();
      GeneralLedgerSetup."Adjust for Payment Disc." := NewAdjustValue;
