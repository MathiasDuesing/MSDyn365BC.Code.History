codeunit 136102 "Service Contracts"
{
    ...
    var
        ...
        ServiceContractErrorServTierErr: Label 'Change Status must be equal to ''Open''  in Service Contract Header: Contract Type=%1, Contract No.=%2. Current value is ''Locked''.';
