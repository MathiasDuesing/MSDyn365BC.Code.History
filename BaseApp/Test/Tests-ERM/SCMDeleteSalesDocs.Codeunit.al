codeunit 137208 "SCM Delete Sales Docs"
{
    ...
    [ReportHandler]
    [Scope('OnPrem')]
    procedure SalesShipReportHandler(var SalesShipment: Report "Sales Shipment NA")
    var
        SalesShipmentHeader: Record "Sales Shipment Header";
        FilePath: Text;
    begin
    ...
    [ReportHandler]
    [Scope('OnPrem')]
    procedure RetRcptReportHandler(var SalesReturnReceipt: Report "Return Receipt")
    var
        ReturnReceiptHeader: Record "Return Receipt Header";
        FilePath: Text;
    begin
    ...
    [ReportHandler]
    [Scope('OnPrem')]
    procedure SalesShipmentXmlReportHandler(var SalesShipment: Report "Sales Shipment NA")
    var
        SalesShipmentHeader: Record "Sales Shipment Header";
    begin
        SalesShipmentHeader.SetFilter("No.", LibraryVariableStorage.DequeueText());
