codeunit 134157 "ERM Posting Rounding"
{
    ...
    begin
        ...
        Assert.RecordCount(GLEntry, 10); // APAC design: GLs are not merged

        VerifyGLEntry(DocumentNo, GLAccountNo[1], 19645.34);
        VerifyGLEntry(DocumentNo, GLAccountNo[2], 10025.89);
        VerifyGLEntry(DocumentNo, GLAccountNo[3], -0.01); // APAC BUG: two GLs are not balanced to zero
    ...
    begin
        ...
        VerifyGLEntry(DocumentNo, GLAccountNo[4], 5477.47);
