codeunit 134154 "ERM Intercompany III"
{
    ...
    begin
        ...
        VerifyHandledICOutboxPurchLineDescription2(HandledICOutboxTrans, "IC Partner Reference Type"::Item, PurchaseLine."No.", PurchaseLine."Description 2");
    ...
    begin
        ...
        FindHandledICOutboxTransaction(
            HandledICOutboxTrans, HandledICOutboxTrans."Source Type"::"Purchase Document",
            ICTransactionDocType::Order, PurchaseHeader."No.", ICPartnerCode);
        VerifyHandledICOutboxPurchLineDescription2(HandledICOutboxTrans, "IC Partner Reference Type"::Item, PurchaseLine."No.", '');
    ...
    begin
        ...
        VerifyHandledICOutboxSalesLineDescription2(HandledICOutboxTrans, "IC Partner Reference Type"::Item, SalesLine."No.", SalesLine."Description 2");
    ...
    begin
        ...
        FindHandledICOutboxTransaction(
            HandledICOutboxTrans, HandledICOutboxTrans."Source Type"::"Sales Document",
            ICTransactionDocType::Order, SalesHeader."No.", ICPartnerCode);
        VerifyHandledICOutboxSalesLineDescription2(HandledICOutboxTrans, "IC Partner Reference Type"::Item, SalesLine."No.", '');
