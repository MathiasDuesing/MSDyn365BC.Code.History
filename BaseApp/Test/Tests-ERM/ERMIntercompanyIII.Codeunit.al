codeunit 134154 "ERM Intercompany III"
{
    ...
    begin
        ...
        Assert.ExpectedConfirm(
            StrSubstNo(SendAgainQst, HandledICOutboxTrans."Document Type"::Order, PurchaseHeader."No.", ICPartnerCode), LibraryVariableStorage.DequeueText());
        Assert.ExpectedErrorCode('Dialog');
        Assert.ExpectedError('');

        // [THEN] Handled IC Outbox contains only one record for this document.
        VerifyHandledICOutboxTransCount(
            HandledICOutboxTrans."Source Type"::"Purchase Document", HandledICOutboxTrans."Document Type"::Order, PurchaseHeader."No.", ICPartnerCode, 1);
    end;
    ...
    begin
        ...
        // [THEN] Sending process was interrupted with Error('').
        Assert.ExpectedConfirm(
            StrSubstNo(SendAgainQst, HandledICOutboxTrans."Document Type"::Invoice, PurchaseHeader."No.", ICPartnerCode), LibraryVariableStorage.DequeueText());
        Assert.ExpectedErrorCode('Dialog');
        Assert.ExpectedError('');

        // [THEN] Handled IC Outbox contains only one record for this document.
        VerifyHandledICOutboxTransCount(
            HandledICOutboxTrans."Source Type"::"Purchase Document", HandledICOutboxTrans."Document Type"::Invoice, PurchaseHeader."No.", ICPartnerCode, 1);
    end;
    ...
    begin
        ...
        // [THEN] Sending process was interrupted with Error('').
        Assert.ExpectedConfirm(
            StrSubstNo(SendAgainQst, HandledICOutboxTrans."Document Type"::"Credit Memo", PurchaseHeader."No.", ICPartnerCode), LibraryVariableStorage.DequeueText());
        Assert.ExpectedErrorCode('Dialog');
        Assert.ExpectedError('');

        // [THEN] Handled IC Outbox contains only one record for this document.
        VerifyHandledICOutboxTransCount(
            HandledICOutboxTrans."Source Type"::"Purchase Document", HandledICOutboxTrans."Document Type"::"Credit Memo", PurchaseHeader."No.", ICPartnerCode, 1);
    end;
    ...
    begin
        ...
        // [THEN] Sending process was interrupted with Error('').
        Assert.ExpectedConfirm(
            StrSubstNo(SendAgainQst, HandledICOutboxTrans."Document Type"::"Return Order", PurchaseHeader."No.", ICPartnerCode), LibraryVariableStorage.DequeueText());
        Assert.ExpectedErrorCode('Dialog');
        Assert.ExpectedError('');

        // [THEN] Handled IC Outbox contains only one record for this document.
        VerifyHandledICOutboxTransCount(
            HandledICOutboxTrans."Source Type"::"Purchase Document", HandledICOutboxTrans."Document Type"::"Return Order", PurchaseHeader."No.", ICPartnerCode, 1);
    end;
    ...
    begin
        ...
        // [THEN] Sending process was interrupted with Error('').
        Assert.ExpectedConfirm(
            StrSubstNo(SendAgainQst, HandledICOutboxTrans."Document Type"::Order, SalesHeader."No.", ICPartnerCode), LibraryVariableStorage.DequeueText());
        Assert.ExpectedErrorCode('Dialog');
        Assert.ExpectedError('');

        // [THEN] Handled IC Outbox contains only one record for this document.
        VerifyHandledICOutboxTransCount(
            HandledICOutboxTrans."Source Type"::"Sales Document", HandledICOutboxTrans."Document Type"::Order, SalesHeader."No.", ICPartnerCode, 1);
    end;
    ...
    begin
        ...
        // [THEN] Sending process was interrupted with Error('').
        Assert.ExpectedConfirm(
            StrSubstNo(SendAgainQst, HandledICOutboxTrans."Document Type"::Invoice, SalesHeader."No.", ICPartnerCode), LibraryVariableStorage.DequeueText());
        Assert.ExpectedErrorCode('Dialog');
        Assert.ExpectedError('');

        // [THEN] Handled IC Outbox contains only one record for this document.
        VerifyHandledICOutboxTransCount(
            HandledICOutboxTrans."Source Type"::"Sales Document", HandledICOutboxTrans."Document Type"::Invoice, SalesHeader."No.", ICPartnerCode, 1);
    end;
    ...
    begin
        ...
        // [THEN] Sending process was interrupted with Error('').
        Assert.ExpectedConfirm(
            StrSubstNo(SendAgainQst, HandledICOutboxTrans."Document Type"::"Credit Memo", SalesHeader."No.", ICPartnerCode), LibraryVariableStorage.DequeueText());
        Assert.ExpectedErrorCode('Dialog');
        Assert.ExpectedError('');

        // [THEN] Handled IC Outbox contains only one record for this document.
        VerifyHandledICOutboxTransCount(
            HandledICOutboxTrans."Source Type"::"Sales Document", HandledICOutboxTrans."Document Type"::"Credit Memo", SalesHeader."No.", ICPartnerCode, 1);
    end;
    ...
    begin
        ...
        // [THEN] Sending process was interrupted with Error('').
        Assert.ExpectedConfirm(
            StrSubstNo(SendAgainQst, HandledICOutboxTrans."Document Type"::"Return Order", SalesHeader."No.", ICPartnerCode), LibraryVariableStorage.DequeueText());
        Assert.ExpectedErrorCode('Dialog');
        Assert.ExpectedError('');

        // [THEN] Handled IC Outbox contains only one record for this document.
        VerifyHandledICOutboxTransCount(
            HandledICOutboxTrans."Source Type"::"Sales Document", HandledICOutboxTrans."Document Type"::"Return Order", SalesHeader."No.", ICPartnerCode, 1);
    end;
    ...
    begin
        ...
        VerifyHandledICOutboxTransCount(
            HandledICOutboxTrans."Source Type"::"Sales Document", HandledICOutboxTrans."Document Type"::Order, SalesHeader."No.", ICPartnerCode, 2);
    end;
    ...
    begin
        ...
        // [THEN] Handled IC Outbox contains two records for this document.
        VerifyHandledICOutboxTransCount(
            HandledICOutboxTrans."Source Type"::"Purchase Document", HandledICOutboxTrans."Document Type"::Order, PurchaseHeader."No.", ICPartnerCode, 2);
    end;
    ...
    begin
        ...
        MockICOutboxTransaction(
            ICOutboxTransaction[1], ICPartnerCode, ICOutboxTransaction[1]."Source Type"::"Purchase Document", ICOutboxTransaction[1]."Document Type"::Invoice, DocumentNo);
        MockICOutboxPurchaseDocument(ICOutboxPurchaseHeader, ICOutboxTransaction[1], VendorNo, 10, 100);
        MockICOutboxTransaction(
            ICOutboxTransaction[2], ICPartnerCode, ICOutboxTransaction[2]."Source Type"::"Purchase Document", ICOutboxTransaction[2]."Document Type"::Invoice, DocumentNo);
        ...
        Assert.ExpectedConfirm(
            StrSubstNo(
                SendAgainQst, HandledICOutboxTrans."Document Type"::Invoice, ICOutboxPurchaseHeader."No.", ICPartnerCode), LibraryVariableStorage.DequeueText());

        // [THEN] Handled IC Outbox contains two records for this document.
        VerifyHandledICOutboxTransCount(
            HandledICOutboxTrans."Source Type"::"Purchase Document", HandledICOutboxTrans."Document Type"::Invoice, ICOutboxPurchaseHeader."No.", ICPartnerCode, 2);
    end;
    ...
    begin
        ...
        VerifyHandledICOutboxTransCount(
            HandledICOutboxTrans."Source Type"::"Purchase Document", HandledICOutboxTrans."Document Type"::Invoice, ICOutboxPurchaseHeader."No.", ICPartnerCode, 1);
    end;
    ...
    begin
        ...
        MockICInboxTransaction(
            ICInboxTransaction[1], ICPartnerCode, ICInboxTransaction[1]."Source Type"::"Sales Document", ICInboxTransaction[1]."Document Type"::Invoice, DocumentNo);
        MockICInboxSalesDocument(ICInboxSalesHeader, ICInboxTransaction[1], CustomerNo, 10, 100);
        MockICInboxTransaction(
            ICInboxTransaction[2], ICPartnerCode, ICInboxTransaction[2]."Source Type"::"Sales Document", ICInboxTransaction[2]."Document Type"::Invoice, DocumentNo);
        ...
        Assert.ExpectedConfirm(
            StrSubstNo(
                AcceptAgainQst, HandledICInboxTrans."Document Type"::Invoice, ICInboxSalesHeader."No.", ICPartnerCode), LibraryVariableStorage.DequeueText());

        // [THEN] Handled IC Inbox contains two records for this document.
        VerifyHandledICInboxTransCount(
            HandledICInboxTrans."Source Type"::"Sales Document", HandledICInboxTrans."Document Type"::Invoice, ICInboxSalesHeader."No.", ICPartnerCode, 2);
    ...
    begin
        ...
        VerifyHandledICInboxTransCount(
            HandledICInboxTrans."Source Type"::"Sales Document", HandledICInboxTrans."Document Type"::Invoice, ICInboxSalesHeader."No.", ICPartnerCode, 1);
    ...
    local procedure MockICOutboxTransaction(var ICOutboxTransaction: Record "IC Outbox Transaction"; ICPartnerCode: Code[20]; SourceType: Option; DocumentType: Option; DocumentNo: Code[20])
    begin
        with ICOutboxTransaction do begin
            Init();
    ...
    local procedure MockICInboxTransaction(var ICInboxTransaction: Record "IC Inbox Transaction"; ICPartnerCode: Code[20]; SourceType: Option; DocumentType: Option; DocumentNo: Code[20])
    begin
    ...
    local procedure VerifyHandledICOutboxTransCount(SourceType: Option; DocumentType: Option; DocumentNo: Code[20]; ICPartnerCode: Code[20]; ExpectedCount: Integer)
    var
        HandledICOutboxTrans: Record "Handled IC Outbox Trans.";
    begin
    ...
    local procedure VerifyHandledICInboxTransCount(SourceType: Option; DocumentType: Option; DocumentNo: Code[20]; ICPartnerCode: Code[20]; ExpectedCount: Integer)
    var
        HandledICInboxTrans: Record "Handled IC Inbox Trans.";
    begin
