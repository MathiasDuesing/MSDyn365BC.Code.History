codeunit 134194 "Test Adv. Intrastat Checklist"
{
    ...
    begin
        ...
        // [GIVEN] Advanced Intrastat Checklist setup for two fields "Transport Method", "Partner VAT ID" for report "Intrastat - Make Disk Tax Auth"
        CreateFieldSetup(Report::"Intrastat - Make Disk Tax Auth", IntrastatJnlLine[1].FieldNo("Transport Method"), '');
        CreateFieldSetup(Report::"Intrastat - Make Disk Tax Auth", IntrastatJnlLine[1].FieldNo("Partner VAT ID"), '');

        // [GIVEN] Intrastat journal with two lines: first with blanked "Transport Method" field, second with blanked "Partner VAT ID" field
        IntrastatJnlBatch.DeleteAll();
        ...
        IntrastatJnlLine[2]."Partner VAT ID" := '';
        ...
        VerifyError();
        VerifyBatchTwoErrors(IntrastatJnlLine[1], IntrastatJnlLine[1].FieldName("Transport Method"), IntrastatJnlLine[1].FieldName("Partner VAT ID"));
        VerifyJnlLineSingleError(IntrastatJnlLine[1], IntrastatJnlLine[1].FieldName("Transport Method"));
        VerifyJnlLineSingleError(IntrastatJnlLine[2], IntrastatJnlLine[2].FieldName("Partner VAT ID"));
    end;
