codeunit 134194 "Test Adv. Intrastat Checklist"
{
    ...
    begin
        // [FEATURE] [UI]
        // [SCENARIO 395476] Report 593 "Intrastat - Make Declaration" in case of no errors
        Initialize();
    ...
    begin
        // [FEATURE] [UI]
        // [SCENARIO 395476] Report 593 "Intrastat - Make Declaration" in case of single error
        Initialize();
        IntrastatJnlBatch.DeleteAll();
        CreateJournalLine(IntrastatJnlLine);
        CreateFieldSetup(Report::"Intrastat - Make Declaration", IntrastatJnlLine.FieldNo("Item No."), '');
    ...
    begin
        // [FEATURE] [UI]
        // [SCENARIO 395476] Report 593 "Intrastat - Make Declaration" in case of two errors
        Initialize();
        IntrastatJnlBatch.DeleteAll();
        CreateJournalLine(IntrastatJnlLine);
        CreateFieldSetup(Report::"Intrastat - Make Declaration", IntrastatJnlLine.FieldNo("Item No."), '');
        CreateFieldSetup(Report::"Intrastat - Make Declaration", IntrastatJnlLine.FieldNo("Transport Method"), '');
    ...
    begin
        ...
        CreateFieldSetup(Report::"Intrastat - Make Declaration", IntrastatJnlLine[1].FieldNo("Transport Method"), '');
        CreateFieldSetup(Report::"Intrastat - Make Declaration", IntrastatJnlLine[1].FieldNo(Area), '');
    ...
    begin
        ...
        Commit();
        IntrastatMakeDeclaration.InitializeRequest(LibraryReportDataset.GetFileName());
    ...
    [RequestPageHandler]
    procedure IntrastatMakeDiskTaxAuthRPH(var IntrastatMakeDeclaration: TestRequestPage "Intrastat - Make Declaration")
    begin
