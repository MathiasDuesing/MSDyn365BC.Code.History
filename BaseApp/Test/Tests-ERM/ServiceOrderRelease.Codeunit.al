codeunit 136140 "Service Order Release"
{
    ...
    begin
        ...
        Assert.AreEqual(
          StrSubstNo(
            OpenServiceOrderWarehouseShipmentErr,
    ...
    begin
        ...
        Assert.AreEqual(
          StrSubstNo(
            OpenServiceOrderWarehouseShipmentErr, ServiceHeader."Release Status"::Open,
    ...
    begin
        ...
        Assert.AreEqual(
          StrSubstNo(BlockedItemErrorMsg, Item."No."), GetLastErrorText,
    ...
    begin
        ...
        Assert.AreEqual(
          StrSubstNo(
            ShippedNotInvoicedErr, Quantity, ServiceShipmentHeaderNo,
