codeunit 135060 "Document Mailing Tests"
{
    ...
    procedure SendPostedSalesInvoiceInBackgroundConfirmDefaultProfileUsingDefaultSettingsAndPdfAndNotCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Invoice when Select sending options = "ConfirmDefault" Document Sending Profile using default setting, E-Mail Attachment = "PDF" and Combine Email Documents = false.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
        ...
        SendPostedSalesInvoices(true, 2, 4, 2, 2);
    ...
    procedure SendPostedSalesInvoiceInForegroundConfirmDefaultProfileUsingPromptForSettingsAndPdfAndNotCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Invoice when Select sending options = "ConfirmDefault" Document Sending Profile using prompt for settings, E-Mail Attachment = "PDF" and Combine Email Documents = false.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
        ...
        SendPostedSalesInvoices(false, 2, 4, 2, 2);
        Assert.AreEqual(1, ModalCount, 'SelectSendingOptions modal did not open the correct number of times');
    end;

    [Test]
    [HandlerFunctions('SelectSendingOptionsOKModalPageHandler,SelectSendingOptionsStrMenuHandler')]
    procedure SendPostedSalesInvoiceInBackgroundConfirmDefaultProfileUsingDefaultSettingsAndPdfAndCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Invoice when Select sending options = "ConfirmDefault" Document Sending Profile using default setting, E-Mail Attachment = "PDF" and Combine Email Documents = true.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
        ...
        SendPostedSalesInvoices(true, 3, 2, 2, 1);
        Assert.AreEqual(1, ModalCount, 'SelectSendingOptions modal did not open the correct number of times');
    end;

    [Test]
    [HandlerFunctions('SelectSendingOptionsOKModalPageHandler,SelectSendingOptionsStrMenuHandler,EmailEditorSendModalPageHandler')]
    procedure SendPostedSalesInvoiceInForegroundConfirmDefaultProfileUsingPromptForSettingsAndPdfAndCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Invoice when Select sending options = "ConfirmDefault" Document Sending Profile using prompt for settings, E-Mail Attachment = "PDF" and Combine Email Documents = true.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
        ...
        SendPostedSalesInvoices(false, 3, 2, 2, 1);
        Assert.AreEqual(1, ModalCount, 'SelectSendingOptions modal did not open the correct number of times');
    end;

    [Test]
    [HandlerFunctions('SelectSendingOptionsStrMenuHandler')]
    procedure SendPostedSalesInvoiceInBackgroundUseDefaultProfileUsingDefaultSettingsAndPdfAndNotCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Invoice when Select sending options = "UseDefaultProfile" Document Sending Profile using default setting, E-Mail Attachment = "PDF" and Combine Email Documents = false.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
    ...
    procedure SendPostedSalesInvoiceInForegroundUseDefaultProfileUsingPromptForSettingsAndPdfAndNotCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Invoice when Select sending options = "UseDefaultProfile" Document Sending Profile using prompt for settings, E-Mail Attachment = "PDF" and Combine Email Documents = false.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
    ...
    [Test]
    [HandlerFunctions('SelectSendingOptionsStrMenuHandler')]
    procedure SendPostedSalesInvoiceInBackgroundUseDefaultProfileUsingDefaultSettingsAndPdfAndCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Invoice when Select sending options = "UseDefaultProfile" Document Sending Profile using default setting, E-Mail Attachment = "PDF" and Combine Email Documents = true.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
    ...
    [Test]
    [HandlerFunctions('SelectSendingOptionsStrMenuHandler,EmailEditorSendModalPageHandler')]
    procedure SendPostedSalesInvoiceInForegroundUseDefaultProfileUsingPromptForSettingsAndPdfAndCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Invoice when Select sending options = "UseDefaultProfile" Document Sending Profile using prompt for settings, E-Mail Attachment = "PDF" and Combine Email Documents = true.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
    ...
    local procedure SendPostedSalesInvoices(RunJQ: Boolean; InvoicesCount: Integer; JQCount: Integer; CustomersCount: Integer; EmailCount: Integer)
    var
        Customer: Record Customer;
        JobQueueEntry: Record "Job Queue Entry";
        SalesInvoiceHeader: Record "Sales Invoice Header";
    ...
    begin
        ...
        // [GIVEN] Create Posted sales invoices for above customer
        for Count := 1 to CustomersCount do begin
            CustomerNos.Get(Count, CustomerNo);
            Customer.Get(CustomerNo);
            CreateMultipleSalesInvoicesForCustomer(Customer, InvoicesCount);
            StrBuilder.Append(CustomerNo + '|');
        end;
        SalesInvoiceHeader.SetFilter("Sell-to Customer No.", StrBuilder.ToText().TrimEnd('|'));
        SalesInvoiceHeader.FindSet();
        Assert.RecordCount(SalesInvoiceHeader, InvoicesCount * CustomersCount);

        // [WHEN] Send Posted Sales Invoices.
        SalesInvoiceHeader.SendRecords();
    ...
    [Test]
    [HandlerFunctions('SelectSendingOptionsOKModalPageHandler,SelectSendingOptionsStrMenuHandler')]
    procedure SendPostedSalesCreditMemosInBackgroundConfirmDefaultProfileUsingDefaultSettingsAndPdfAndNotCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Credit Memos when Select sending options = "ConfirmDefault" Document Sending Profile using default setting, E-Mail Attachment = "PDF" and Combine Email Documents = false.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
        ...
        SendPostedSalesCreditMemos(true, 2, 4, 2, 2);
    ...
    [Test]
    [HandlerFunctions('SelectSendingOptionsOKModalPageHandler,SelectSendingOptionsStrMenuHandler,EmailEditorSendModalPageHandler')]
    procedure SendPostedSalesCreditMemosInForegroundConfirmDefaultProfileUsingPromptForSettingsAndPdfAndNotCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Credit Memos when Select sending options = "ConfirmDefault" Document Sending Profile using prompt for settings, E-Mail Attachment = "PDF" and Combine Email Documents = false.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
        ...
        SendPostedSalesCreditMemos(false, 2, 4, 2, 2);
        Assert.AreEqual(1, ModalCount, 'SelectSendingOptions modal did not open the correct number of times');
    end;

    [Test]
    [HandlerFunctions('SelectSendingOptionsOKModalPageHandler,SelectSendingOptionsStrMenuHandler')]
    procedure SendPostedSalesCreditMemosInBackgroundConfirmDefaultProfileUsingDefaultSettingsAndPdfAndCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Credit Memos when Select sending options = "ConfirmDefault" Document Sending Profile using default setting, E-Mail Attachment = "PDF" and Combine Email Documents = true.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
        ...
        SendPostedSalesCreditMemos(true, 3, 2, 2, 1);
        Assert.AreEqual(1, ModalCount, 'SelectSendingOptions modal did not open the correct number of times');
    end;

    [Test]
    [HandlerFunctions('SelectSendingOptionsOKModalPageHandler,SelectSendingOptionsStrMenuHandler,EmailEditorSendModalPageHandler')]
    procedure SendPostedSalesCreditMemosInForegroundConfirmDefaultProfileUsingPromptForSettingsAndPdfAndCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Credit Memos when Select sending options = "ConfirmDefault" Document Sending Profile using prompt for settings, E-Mail Attachment = "PDF" and Combine Email Documents = true.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
        ...
        SendPostedSalesCreditMemos(false, 3, 2, 2, 1);
        Assert.AreEqual(1, ModalCount, 'SelectSendingOptions modal did not open the correct number of times');
    end;

    [Test]
    [HandlerFunctions('SelectSendingOptionsStrMenuHandler')]
    procedure SendPostedSalesCreditMemosInBackgroundUseDefaultProfileUsingDefaultSettingsAndPdfAndNotCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Credit Memos when Select sending options = "UseDefaultProfile" Document Sending Profile using default setting, E-Mail Attachment = "PDF" and Combine Email Documents = false.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
    ...
    [Test]
    [HandlerFunctions('SelectSendingOptionsStrMenuHandler,EmailEditorSendModalPageHandler')]
    procedure SendPostedSalesCreditMemosInForegroundUseDefaultProfileUsingPromptForSettingsAndPdfAndNotCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Credit Memos when Select sending options = "UseDefaultProfile" Document Sending Profile using prompt for settings, E-Mail Attachment = "PDF" and Combine Email Documents = false.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
    ...
    [Test]
    [HandlerFunctions('SelectSendingOptionsStrMenuHandler')]
    procedure SendPostedSalesCreditMemosInBackgroundUseDefaultProfileUsingDefaultSettingsAndPdfAndCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Credit Memos when Select sending options = "UseDefaultProfile" Document Sending Profile using default setting, E-Mail Attachment = "PDF" and Combine Email Documents = true.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
    ...
    [Test]
    [HandlerFunctions('SelectSendingOptionsStrMenuHandler,EmailEditorSendModalPageHandler')]
    procedure SendPostedSalesCreditMemosInForegroundUseDefaultProfileUsingPromptForSettingsAndPdfAndCombineEmails()
    var
        DocumentSendingProfile: Record "Document Sending Profile";
    begin
        // [SCENARIO] Send Posted Sales Credit Memos when Select sending options = "UseDefaultProfile" Document Sending Profile using prompt for settings, E-Mail Attachment = "PDF" and Combine Email Documents = true.
        Initialize();
        LibraryWorkflow.SetUpEmailAccount();
    ...
    local procedure SendPostedSalesCreditMemos(RunJQ: Boolean; InvoicesCount: Integer; JQCount: Integer; CustomersCount: Integer; EmailCount: Integer)
    var
        Customer: Record Customer;
        JobQueueEntry: Record "Job Queue Entry";
    ...
    begin
        ...
        // [GIVEN] Create Posted Sales Credit Memos for above customer
        for Count := 1 to CustomersCount do begin
            CustomerNos.Get(Count, CustomerNo);
            Customer.Get(CustomerNo);
            CreateMultipleSalesCreditMemoForCustomer(Customer, InvoicesCount);
            StrBuilder.Append(CustomerNo + '|');
        end;
        SalesCrMemoHeader.SetFilter("Sell-to Customer No.", StrBuilder.ToText().TrimEnd('|'));
        SalesCrMemoHeader.FindSet();
        Assert.RecordCount(SalesCrMemoHeader, InvoicesCount * CustomersCount);

        // [WHEN] Send Posted Sales Credit Memo
