codeunit 134976 "ERM Sales Report"
{
    ...
    begin
        ...
        VerifySalesInvoiceTotalsWithDiscount(SalesLine, 'AB', 89);
    end;
    ...
    begin
        ...
        // [THEN] VAT Amount = 200
        // [THEN] Amount Including VAT = 1200
        VerifySalesInvoiceTotalsWithDiscount(SalesLine, 'AB', 90);
    end;
    ...
    begin
        ...
        with SalesCreditMemoReport do begin
            ...
            InitializeRequest(0, false, false, false);
            LibraryVariableStorage.Enqueue(true);
            Run;
        end;
    end;
    ...
    begin
        LibraryReportValidation.OpenExcelFile;
        LibraryReportValidation.VerifyCellValue(46, 13, YourReference);
    end;

    local procedure VerifyAmountsSalesInvoiceReport(ExpectedAmount: Decimal; ExpectedAmountInclVAT: Decimal)
    begin
        LibraryReportValidation.OpenExcelFile;
        LibraryReportValidation.VerifyCellValue(91, 28, LibraryReportValidation.FormatDecimalValue(ExpectedAmount)); // Total Amount
        LibraryReportValidation.VerifyCellValue(
          92, 28, LibraryReportValidation.FormatDecimalValue(ExpectedAmountInclVAT - ExpectedAmount)); // Total VAT
        LibraryReportValidation.VerifyCellValue(94, 28, LibraryReportValidation.FormatDecimalValue(ExpectedAmountInclVAT)); // Total Amount Incl. VAT
    end;
    ...
    begin
        LibraryVariableStorage.Dequeue(AlwaysShowVATSum);
        SalesCreditMemo.AlwaysShowVATSum.SetValue(AlwaysShowVATSum);
