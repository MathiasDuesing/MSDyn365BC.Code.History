codeunit 134976 "ERM Sales Report"
{
    ...
    begin
        ...
        VerifySalesInvoiceTotalsWithDiscount(SalesLine, 'AE', 87);
    end;
    ...
    begin
        ...
        // [THEN] VAT Amount = 200
        // [THEN] Amount Including VAT = 1200
        VerifySalesInvoiceTotalsWithDiscount(SalesLine, 'AE', 88);
    end;
    ...
    begin
        ...
        LibraryReportDataset.LoadDataSetFile;
        LibraryReportDataset.MoveToRow(LibraryReportDataset.RowCount - 2);
    ...
    begin
        ...
        LibraryReportValidation.VerifyCellValue(92, 31, LibraryReportValidation.FormatDecimalValue(ExpectedAmountInclVAT)); // Total Amount Incl. VAT
    end;
