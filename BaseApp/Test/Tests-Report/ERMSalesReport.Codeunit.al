codeunit 134976 "ERM Sales Report"
{
    ...
    [Scope('OnPrem')]
    procedure SalesCreditMemoReportWithEnabledPrintVATSpecInLCY()
    var
        SalesHeader: Record "Sales Header";
        DocumentNo: Code[20];
    begin
        ...
        // Excercise
        CreateAndSetupSalesDocument(SalesHeader, SalesHeader."Document Type"::"Credit Memo");
        DocumentNo := LibrarySales.PostSalesDocument(SalesHeader, true, true);
        RunSalesCreditMemoReport(DocumentNo);

        // Verify
        VerifySalesCreditMemoVATAmountInLCY(DocumentNo);
    end;
    ...
    begin
        ...
        VerifySalesInvoiceTotalsWithDiscount(SalesLine, 'Z', 94);
    end;
    ...
    begin
        ...
        // [THEN] VAT Amount = 200
        // [THEN] Amount Including VAT = 1200
        VerifySalesInvoiceTotalsWithDiscount(SalesLine, 'Z', 95);
    end;
    ...
    begin
        ...
        // [THEN] Value "XXX" is displayed under Tag <SalesOrderReference_SalesHeader> in export XML file
        LibraryReportDataset.AssertElementTagWithValueExists('SalesOrderReference_SalesHeader', SalesHeader."External Document No.");
    ...
    begin
        ...
        LibraryReportValidation.VerifyCellValue(23, 18, SalesHeader."External Document No.");
    end;
    ...
    begin
        ...
        LibraryReportValidation.VerifyCellValue(9, 24, InvoiceTxt);
    end;
    ...
    begin
        ...
        ReportTotalsBuffer.Add('', 0, true, true, true, CurrencyCode);

        // [THEN] "Amount Formatted" = 123.123
        ReportTotalsBuffer.FindFirst();
        Assert.IsTrue(ReportTotalsBuffer."Amount Formatted".EndsWith('.000'), WrongDecimalErr);
    end;
    ...
    begin
        LibraryReportValidation.OpenExcelFile;
        LibraryReportValidation.VerifyCellValue(53, 12, YourReference);
    end;

    local procedure VerifyAmountsSalesInvoiceReport(ExpectedAmount: Decimal; ExpectedAmountInclVAT: Decimal)
    begin
        LibraryReportValidation.OpenExcelFile;
        LibraryReportValidation.VerifyCellValue(97, 26, LibraryReportValidation.FormatDecimalValue(ExpectedAmount)); // Total Amount
        LibraryReportValidation.VerifyCellValue(
          98, 26, LibraryReportValidation.FormatDecimalValue(ExpectedAmountInclVAT - ExpectedAmount)); // Total VAT
        LibraryReportValidation.VerifyCellValue(100, 26, LibraryReportValidation.FormatDecimalValue(ExpectedAmountInclVAT)); // Total Amount Incl. VAT
    end;
    ...
    local procedure VerifySalesReportVATAmount(DocumentType: Enum "Gen. Journal Document Type"; DocumentNo: Code[20]; Sign: Integer)
    var
        VATEntry: Record "VAT Entry";
    begin
