codeunit 134076 "ERM Suggest Vendor Payment"
{
    ...
    begin
        ...
        // [GIVEN] Vendor Ledger Entry of Invoice "INV" for vendor "V" with blank Message To Recipient
        CreatePostVendorEntryWithMsgToRecipient(VendorLedgerEntry, '');

        // [WHEN] Run Suggest Vendor Payment for "V"
        ...
        // [THEN] Gen. Journal Line is created with Message To Recipient = 'Payment of Invoice "INV" to vendor "V"' (TfsId 234269).
