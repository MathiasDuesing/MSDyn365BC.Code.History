codeunit 134076 "ERM Suggest Vendor Payment"
{
    ...
    begin
        ...
        // [GIVEN] Posted Invoice for Vendor A for Amount = 100
        CreateGeneralJournalBatch(GenJournalBatch, GenJournalTemplate.Type::General);
        BankAccountNo := SetupAndCreateGenJournalLinesWithVendorBankAccountForElectronicPayments(GenJournalLine, GenJournalBatch);
        LibraryERM.PostGeneralJnlLine(GenJournalLine);
        VendorNo := GenJournalLine."Account No.";
    ...
    local procedure SetupAndCreateGenJournalLinesWithVendorBankAccountForElectronicPayments(var GenJournalLine: Record "Gen. Journal Line"; GenJournalBatch: Record "Gen. Journal Batch") BankAccountNo: Code[20]
    var
        VendorNo: Code[20];
    begin
        BankAccountNo := LibraryERM.CreateBankAccountNo;
