codeunit 137161 "SCM Warehouse Orders"
{
    ...
    var
        ...
        ConfirmLinkToEmptyLineMsg: Label 'Usage will not be linked to the job planning line because the Line Type field is empty';
    ...
    begin
        ...
        PurchaseSetup.Get();
        AddNoSeriesLine(PurchaseSetup."Order Nos.", DMY2Date(1, 1, Date2DMY(WorkDate(), 3)));
        AddNoSeriesLine(PurchaseSetup."Posted Receipt Nos.", DMY2Date(1, 1, Date2DMY(WorkDate(), 3)));
    ...
    local procedure AddNoSeriesLine(NoSeriesCode: Code[10]; StartingDate: Date)
    var
        NoSeriesLine: Record "No. Series Line";
    begin
