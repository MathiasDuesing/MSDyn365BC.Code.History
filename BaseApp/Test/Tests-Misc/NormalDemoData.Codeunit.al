codeunit 138200 "Normal DemoData"
{
    ...
    begin
        Assert.RecordCount(AdvancedIntrastatChecklist, 14);
        ...
        AdvancedIntrastatChecklistField(Report::"Intrastat - Form", IntrastatJnlLine.FieldNo("Conversion Factor"), 'Supplementary Units: Yes');
    end;
