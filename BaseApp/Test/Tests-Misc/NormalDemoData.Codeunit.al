codeunit 138200 "Normal DemoData"
{
    ...
    begin
        Assert.RecordCount(AdvancedIntrastatChecklist, 22);
        ...
        AdvancedIntrastatChecklistCommonFields(Report::"Intrastat - Make Declaration");

        AdvancedIntrastatChecklistField(Report::"Intrastat - Checklist", IntrastatJnlLine.FieldNo("Transport Method"), '');
