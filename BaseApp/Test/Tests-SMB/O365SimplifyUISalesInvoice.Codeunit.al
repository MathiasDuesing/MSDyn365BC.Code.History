codeunit 138000 "O365 Simplify UI Sales Invoice"
{
    ...
    begin
        ...
        FieldListToExclude.Add(SalesHeaderRef.FieldName("VAT Date"));
        FieldListToExclude.Add(SalesHeaderRef.FieldName("Prepayment Type"));
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure QuoteReportRequestPageHandler(var StandardSalesQuote: TestRequestPage "Sales - Quote CZ")
    begin
    end;
