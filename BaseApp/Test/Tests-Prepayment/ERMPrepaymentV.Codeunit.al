codeunit 134106 "ERM Prepayment V"
{
    ...
    begin
        ...
        DocumentNo := PostPurchaseDocument(PurchaseHeader); // This differs from W1. TODO: align with W1.

        // [THEN] The invoice has been posted
        VerifyGLAccountBalance(VATPostingSetup."Purchase VAT Account", DocumentNo, 1603585.1);
        VerifyVendorPayablesAccountAmount(PurchaseHeader."Vendor Posting Group", DocumentNo, -17639431.1);
    ...
    begin
        ...
        // [WHEN] Post final invoice
        DocumentNo := LibrarySales.PostSalesDocument(SalesHeader, true, true); // This differs from W1. TODO: align with W1.

        // [THEN] The invoice has been posted
        VerifyGLAccountBalance(VATPostingSetup."Sales VAT Account", DocumentNo, -1603585.1);
        VerifyCustomerReceivablesAccountAmount(SalesHeader."Customer Posting Group", DocumentNo, 17639431.1);
    ...
    begin
        ...
        // [THEN] The invoice has been posted
        VerifyGLAccountBalance(VATPostingSetup."Purchase VAT Account", DocumentNo, 1706000.5);
        VerifyVendorPayablesAccountAmount(PurchaseHeader."Vendor Posting Group", DocumentNo, -18766001.5);
    ...
    begin
        ...
        // [THEN] The invoice has been posted
        VerifyGLAccountBalance(VATPostingSetup."Sales VAT Account", DocumentNo, -1706000.5);
        VerifyCustomerReceivablesAccountAmount(SalesHeader."Customer Posting Group", DocumentNo, 18766001.5);
    ...
    begin
        ...
        Initialize();
        LibrarySales.SetInvoiceRounding(false);
        LibrarySales.SetPostInvoiceDiscount(true);
        PrepareCustomerAndTwoItemsWithSetup(VATPostingSetup, CustomerNo, ItemNo, 19);
