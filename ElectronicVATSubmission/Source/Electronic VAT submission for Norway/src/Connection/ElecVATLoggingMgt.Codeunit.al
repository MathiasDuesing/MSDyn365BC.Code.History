codeunit 10688 "Elec. VAT Logging Mgt."
{
    ...
    var
        ...
        DocType: Enum "Attachment Document Type";
    begin
        InsertDocAttachment(TempBlob, VATReportHeader, DocType::"VAT Return Submission", FileName, 'xml', DocumentAttachment."File Type"::XML, '');
    end;
    ...
    begin
        ...
        InsertDocAttachment(TempBlob, VATReportHeader, DocType, FileName, 'xml', DocumentAttachment."File Type"::XML, '');
    end;
    ...
    var
        ...
        DocType: Enum "Attachment Document Type";
    begin
        InsertDocAttachment(TempBlob, VATReportHeader, DocType::"VAT Return Response", FileName, 'pdf', DocumentAttachment."File Type"::PDF, 'application/pdf');
    end;
    ...
    var
        ...
        DocType: Enum "Attachment Document Type";
    begin
        InsertDocAttachment(TempBlob, VATReportHeader, DocType::"VAT Return Response", FileName, 'xml', DocumentAttachment."File Type"::XML, '');
    end;

    local procedure InsertDocAttachment(var TempBlob: Codeunit "Temp Blob"; VATReportHeader: Record "VAT Report Header"; DocType: Enum "Attachment Document Type"; FileName: Text; FileExtension: Text; FileType: Option; MimeType: Text)
    var
        DocumentAttachment: Record "Document Attachment";
        ID: Integer;
