...
dotnet
{
    assembly("DocumentFormat.OpenXml")
    {
        ...
        type("DocumentFormat.OpenXml.Spreadsheet.Color"; "Spreadsheet.Color")
        {
        }
    ...
    assembly("Microsoft.Dynamics.Nav.LicensingService.Model")
    {
        ...
        type("Microsoft.Dynamics.Nav.LicensingService.Model.GroupInfo"; "GroupInfo")
        {
        }

        type("Microsoft.Dynamics.Nav.LicensingService.Model.LicenseUnitsInfo"; "LicenseUnitsInfo")
        {
        }
    ...
    assembly("Microsoft.Dynamics.Nav.OLSync.Common")
    {
        ...
        type("Microsoft.Dynamics.NAV.OLSync.Common.XmlTextReader"; "OLSync.Common.XmlTextReader")
        {
        }

        type("Microsoft.Dynamics.NAV.OLSync.Common.XmlTextWriter"; "OLSync.Common.XmlTextWriter")
        {
        }
    }
    ...
    assembly("Microsoft.Dynamics.Nav.OpenXml")
    {
        ...
        type("Microsoft.Dynamics.Nav.OpenXml.Spreadsheet.CellPosition"; "CellPosition")
        {
        }
    ...
    assembly("Microsoft.Dynamics.Platform.Integration.Office")
    {
        ...
        type("Microsoft.Dynamics.Platform.Integration.Office.FieldInfo"; "Office.FieldInfo")
        {
        }
