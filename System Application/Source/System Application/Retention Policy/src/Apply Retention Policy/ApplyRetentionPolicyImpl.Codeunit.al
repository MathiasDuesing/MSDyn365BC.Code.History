...
codeunit 3904 "Apply Retention Policy Impl."
{
    ...
    begin
        TempDummyPermission := GetEffectivePermission(TempDummyPermission."Object Type"::"Table Data", TableId);
        exit(TempDummyPermission."Delete Permission" = TempDummyPermission."Delete Permission"::Indirect)
    end;

    local procedure GetEffectivePermission(UserSecurityIdToCheck: Guid; CompanyNameToCheck: Text; PermissionObjectType: Option "Table Data","Table",,"Report",,"Codeunit","XMLport","MenuSuite","Page","Query","System",,,,,,,,,; ObjectId: Integer): Text
    var
    ...
    local procedure GetEffectivePermission(PermissionObjectType: Option "Table Data","Table",,"Report",,"Codeunit","XMLport","MenuSuite","Page","Query","System",,,,,,,,,; ObjectId: Integer) TempPermission: Record Permission temporary
    var
        PermissionMask: Text;
    begin
        TempPermission."Object Type" := PermissionObjectType;
        ...
        Evaluate(TempPermission."Read Permission", SelectStr(1, PermissionMask));
        Evaluate(TempPermission."Insert Permission", SelectStr(2, PermissionMask));
        Evaluate(TempPermission."Modify Permission", SelectStr(3, PermissionMask));
        Evaluate(TempPermission."Delete Permission", SelectStr(4, PermissionMask));
        Evaluate(TempPermission."Execute Permission", SelectStr(5, PermissionMask));
    end;
