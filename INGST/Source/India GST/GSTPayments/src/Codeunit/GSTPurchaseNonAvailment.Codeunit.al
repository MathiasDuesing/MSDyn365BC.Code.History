codeunit 18251 "GST Purchase Non Availment"
{
    ...
    local procedure FillGenJournalLineNonAvailmentFA(var GenJournalLine: Record "Gen. Journal Line"; InvoicePostBuffer: Record "Invoice Post. Buffer")
    begin
        GenJournalLine."FA Non-Availment" := InvoicePostBuffer."FA Non-Availment";
        GenJournalLine."FA Non-Availment Amount" := InvoicePostBuffer."FA Non-Availment Amount";
    end;
