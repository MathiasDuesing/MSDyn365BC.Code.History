page 18557 "Journal Voucher"
{
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number of the incoming document that this Journal Voucher line is created for.';
                    Visible = false;
                ...
                field("Job Queue Status"; Rec."Job Queue Status")
                {
                    ...
                    ToolTip = 'Specifies the status of a job queue entry or task that handles the posting of Journal Vouchers.';
                ...
                field("Applied Automatically"; Rec."Applied Automatically")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = false;
                    ToolTip = 'Specifies that the Journal Voucher line has been automatically applied with a matching payment using the Apply Automatically function.';
                    Visible = false;
                }
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action(GetStandardJournals)
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    ToolTip = 'Select a standard Journal Voucher to be inserted.';
                    ...
                    begin
                        ...
                        if Page.RunModal(Page::"Standard General Journals", StdGenJnl) = Action::LookupOK then begin
                            ...
                            Message(JournalVoucherInsertedMsg, StdGenJnl.Code);
                        end;
            ...
            group("Opening Balance")
            {
                ...
                group("Prepare journal")
                {
                    ...
                    action("G/L Accounts Opening balance ")
                    {
                        ...
                        ToolTip = 'Creates Journal Voucher line per G/L account to enable manual entry of G/L account open balances during the setup of a new company';
                    ...
                    action("Customers Opening balance")
                    {
                        ...
                        Image = TransferToGeneralJournal;
                        ToolTip = 'Creates Journal Voucher line per Customer to enable manual entry of Customer open balances during the setup of a new company';
                    ...
                    action("Vendors Opening balance")
                    {
                        ...
                        Image = TransferToGeneralJournal;
                        ToolTip = 'Creates a Journal Voucher line for each vendor. This lets you manually enter open balances for vendors when you set up a new company.';
            ...
            group("Page")
            {
                ...
                action(ClassicView)
                {
                    ...
                    begin
                        ...
                        CurrPage.Close();
                        GenJnlManagement.SetJournalSimplePageModePreference(false, Page::"Journal Voucher");
                        GenJnlManagement.SetLastViewedJournalBatchName(Page::"Journal Voucher", CurrentJnlBatchName);
                        Page.Run(Page::"Journal Voucher");
                    end;
                }
                action(SimpleView)
                {
                    ...
                    begin
                        ...
                        CurrPage.Close();
                        GenJnlManagement.SetJournalSimplePageModePreference(true, Page::"Journal Voucher");
                        GenJnlManagement.SetLastViewedJournalBatchName(Page::"Journal Voucher", CurrentJnlBatchName);
                        Page.Run(Page::"Journal Voucher");
                    end;
                }
    ...
    begin
        ...
        then
            ...
            IsSimplePage := GenJnlManagement.GetJournalSimplePageModePreference(Page::"Journal Voucher");
    ...
    begin
        ...
        VoucherFunctions.VoucherTemplateSelection(Page::"Journal Voucher", VoucherEnum::"Journal Voucher", false, Rec, JnlSelected);
        if not JnlSelected then
            Error('');

        LastGenJnlBatch := GenJnlManagement.GetLastViewedJournalBatchName(Page::"Journal Voucher");
    ...
    var
        ...
        JournalVoucherInsertedMsg: Label 'Journal Voucher lines have been successfully inserted from Standard Journal Voucher %1.', Comment = '%1= StandardGeneralJournal.Code';
