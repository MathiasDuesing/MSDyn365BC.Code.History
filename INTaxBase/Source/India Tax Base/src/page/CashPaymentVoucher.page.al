page 18554 "Cash Payment Voucher"
{
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number of the incoming document that this Cash Payment Voucher line is created for.';
                    Visible = false;
                ...
                field("Job Queue Status"; Rec."Job Queue Status")
                {
                    ...
                    ToolTip = 'Specifies the status of a job queue entry or task that handles the posting of Cash Payment Vouchers.';
                ...
                field("Applied Automatically"; Rec."Applied Automatically")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = false;
                    ToolTip = 'Specifies that the Cash Payment Voucher line has been automatically applied with a matching payment using the Apply Automatically function.';
                    Visible = false;
                }
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action(GetStandardJournals)
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    ToolTip = 'Select a standard Cash Payment Voucher to be inserted.';
            ...
            group("Opening Balance")
            {
                ...
                group("Prepare journal")
                {
                    ...
                    action("G/L Accounts Opening balance ")
                    {
                        ...
                        ToolTip = 'Creates Cash Payment Voucher line per G/L account to enable manual entry of G/L account open balances during the setup of a new company';
                    ...
                    action("Customers Opening balance")
                    {
                        ...
                        Image = TransferToGeneralJournal;
                        ToolTip = 'Creates Cash Payment Voucher line per Customer to enable manual entry of Customer open balances during the setup of a new company';
                    ...
                    action("Vendors Opening balance")
                    {
                        ...
                        Image = TransferToGeneralJournal;
                        ToolTip = 'Creates a Cash Payment Voucher line for each vendor. This lets you manually enter open balances for vendors when you set up a new company.';
    ...
    begin
        ...
        VoucherFunctions.VoucherTemplateSelection(Page::"Cash Payment Voucher", VoucherEnum::"Cash Payment Voucher", false, Rec, JnlSelected);

        if not JnlSelected then
            Error('');

        LastGenJnlBatch := GenJnlManagement.GetLastViewedJournalBatchName(Page::"Cash Payment Voucher");
    ...
    var
        ...
        CashPaymentInsertedMsg: Label 'Cash Payment Voucher lines have been successfully inserted from Standard Cash Payment Voucher %1.', Comment = '%1 = Standard General Journal.Code';
